...
class InterogationTargetIdentificationVideoDataTable extends DataTable
{
    ...
    {
        $id = request()->route('interogg_target_id'); // Asumsi ID diterima dari route
    ...
    {
        $id = request()->route('interogg_target_id'); // Correct parameter name
        ...
        return $this->builder()
            ...
            ->postAjax([
                'url' => route('open.data.interogg-target-id.show', ['interogg_target_id' => $id])
            ])
            ->buttons(
