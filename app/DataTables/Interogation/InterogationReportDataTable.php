...
class InterogationReportDataTable extends DataTable
{
    /**
    ...
    //             $link = route('open.interogation.report.download-file', encrypt($data->id));
    ...
    public function html()
    {
        ...
        return $this->builder()
            ...
            ->postAjax([
                'url' => route('open.interogation.report.index')
            ])
            ->buttons(
    ...
    {
        return 'interogation_report-' . date('YmdHis');
    }
}
