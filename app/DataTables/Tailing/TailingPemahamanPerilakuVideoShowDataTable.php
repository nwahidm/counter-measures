...
class TailingPemahamanPerilakuVideoShowDataTable extends DataTable
{
    ...
    {
        $id = request()->route('pemahaman_perilaku'); // Asumsi ID diterima dari route
    ...
    public function html()
    {
        ...
        return $this->builder()
            ...
            ->postAjax([
                'url' => route('close.tailing.pemahaman-perilaku.show', ['pemahaman_perilaku' => $id])
            ])
            ->buttons(
