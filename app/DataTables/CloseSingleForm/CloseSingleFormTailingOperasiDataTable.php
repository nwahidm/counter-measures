...
class CloseSingleFormTailingOperasiDataTable extends DataTable
{
    ...
    {
        $id = $this->data?->relation_id_tailing_video_2;
    ...
    public function html()
    {
        ...
        return $this->builder()
            ...
            ->postAjax([
                'url' => route('close.singleform.single-form.video.tailing-operasi', ['data_id' => $this->data?->id])
            ])
            ->buttons(
            ...
            ->parameters([
                'initComplete' => "function () {
                                var r = $('#data-table-tailing-operasi tfoot tr');
    ...
    {
        return 'tailing_pemahaman_operasi-' . date('YmdHis');
    }
}
