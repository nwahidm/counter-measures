...
class CloseSingleFormTappingOperasiDataTable extends DataTable
{
    ...
    {
        $id = $this->data?->relation_id_tapping_video_1;
    ...
    public function html()
    {
        ...
        return $this->builder()
            ...
            ->postAjax([
                'url' => route('close.singleform.single-form.video.tapping-operasi', ['data_id' => $this->data?->id])
            ])
            ->buttons(
            ...
            ->parameters([
                'initComplete' => "function () {
                                var r = $('#data-table-tapping-operasi tfoot tr');
    ...
    {
        return 'tapping_operasi-' . date('YmdHis');
    }
}
