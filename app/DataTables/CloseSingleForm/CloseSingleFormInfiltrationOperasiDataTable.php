...
class CloseSingleFormInfiltrationOperasiDataTable extends DataTable
{
    ...
    {
        $id = $this->data?->relation_id_infiltration_video_1;
    ...
    public function html()
    {
        ...
        return $this->builder()
            ...
            ->postAjax([
                'url' => route('close.singleform.single-form.video.infiltration-operasi', ['data_id' => $this->data?->id])
            ])
            ->buttons(
            ...
            ->parameters([
                'initComplete' => "function () {
                                var r = $('#data-table-infiltration-operasi tfoot tr');
    ...
    {
        return 'infiltration_operasi-' . date('YmdHis');
    }
}
