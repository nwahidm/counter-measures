...
class CloseSingleFormInfiltrationDinamikaDataTable extends DataTable
{
    ...
    {
        $id = $this->data?->relation_id_infiltration_video_2;
    ...
    public function html()
    {
        ...
        return $this->builder()
            ...
            ->postAjax([
                'url' => route('close.singleform.single-form.video.infiltration-dinamika', ['data_id' => $this->data?->id])
            ])
            ->buttons(
            ...
            ->parameters([
                'initComplete' => "function () {
                                var r = $('#data-table-infiltration-dinamika tfoot tr');
    ...
    {
        return 'infiltration_dinamika-' . date('YmdHis');
    }
}
