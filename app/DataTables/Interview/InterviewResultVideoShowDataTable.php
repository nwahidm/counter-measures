...
class InterviewResultVideoShowDataTable extends DataTable
{
    ...
    {
        $id = request()->route('hasil'); // Asumsi ID diterima dari route
    ...
    {
        $id = request()->route('hasil'); // Correct parameter name
        ...
        return $this->builder()
            ...
            ->postAjax([
                'url' => route('open.interview.hasil.show', ['hasil' => $id])
            ])
            ->buttons(
