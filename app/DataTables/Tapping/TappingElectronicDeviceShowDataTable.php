...
class TappingElectronicDeviceShowDataTable extends DataTable
{
    /**
    ...
    {
        $id = request()->route('electronic_device'); // Asumsi ID diterima dari route
    ...
    {
        $id = request()->route('electronic_device'); // Correct parameter name
        ...
        return $this->builder()
            ...
            ->postAjax([
                'url' => route('close.tapping.electronic_device.show', ['electronic_device' => $id])
            ])
            ->buttons(
