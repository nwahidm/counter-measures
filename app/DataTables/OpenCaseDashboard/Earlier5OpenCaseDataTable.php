...
namespace App\DataTables\OpenCaseDashboard;
...
class Earlier5OpenCaseDataTable extends DataTable
{
    /**
     ...
     */
    public function query(OpenCase $model): QueryBuilder
    {
        $user = auth()->user();
    ...
    {
        return 'Earlier5OpenCase_' . date('YmdHis');
    }
}
