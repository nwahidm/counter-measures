...
class IntrusionResult extends Model
{
    use HasFactory, HasUuids, SoftDeletes;

    protected $table = 'intrusion_hasil_yang_dicapai';
    protected $guarded = [];
    protected $casts = [
    ...
    {
        return $this->belongsTo(IntrusionTargetEnv::class, 'intrusion_target_environment_id', 'id');
    }
