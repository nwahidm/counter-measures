...
class TappingElectronicDevice extends Model
{
    use HasFactory, HasUuids, SoftDeletes;

    protected $table = 'tapping_electronic_device_2';
    protected $guarded = [];
    protected $casts = [
    ...
    protected $primaryKey = 'id_tapping_electronic_device';
    ...
    {
        return $this->hasMany(TappingIntelligentSignal::class, 'tapping_electronic_device_data_id', 'id_tapping_electronic_device')->withTrashed();
    }
