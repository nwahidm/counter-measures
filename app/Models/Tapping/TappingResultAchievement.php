...
class TappingResultAchievement extends Model
{
    use HasFactory, HasUuids, SoftDeletes;

    protected $table = 'tapping_hasil_yang_dicapai';
    protected $guarded = [];
    protected $casts = [
        'created_at' => 'datetime:Y-m-d H:i:s',
        'updated_at' => 'datetime:Y-m-d H:i:s'
    ];
    protected $primaryKey = 'id_tapping_result_achievement';
    ...
    {
        return $this->belongsTo(TappingIntelligentSignal::class, 'tapping_intelligent_signal_data_id', 'id_tapping_intelligent_signal')->withTrashed();
    }
