...
class ObservDirective extends Model
{
    use HasFactory, HasUuids, SoftDeletes;

    protected $table = 'observation_surat_perintah';
    protected $guarded = [];
    protected $casts = [
        'surat_perintah_date' => 'date:Y-m-d',
        'surat_perintah_date_started' => 'date:Y-m-d',
    ...
    {
        return $this->hasMany(ObservCollectInfo::class, 'surat_perintah_id', 'id');
    }
