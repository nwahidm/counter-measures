...
class ObservThreat extends Model
{
    use HasFactory, HasUuids, SoftDeletes;

    protected $table = 'observation_potensi_aght';
    protected $guarded = [];
    protected $casts = [
        'aght_time' => 'datetime:Y-m-d H:i:s',
    ...
    {
        return $this->hasMany(ObservConnect::class, 'potensi_aght_id', 'id');
    }
