<x-backoffice.layout.app-layout title="Tambah Tahun">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Tambah Tahun" subheading="" breadcrumb="master-tahun-create" icon="fas fa-users">
                    ...
                    <div class="row g-5 g-xl-8">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="form" action="{{ route('master.tahun.store') }}" method="post">
                                        @csrf
    ...
    <script>
        $(document).ready(function(){  
            ...
            $('#add').click(function(){  
                i++;
                row = "<tr>"
                row += "<td><input type='text' class='form-control form-control-solid' name='tahun[" +i+ "][kode]' id='kode' placeholder='ex: 2023' required/></td>";
                row += "<td><input type='text' class='form-control form-control-solid' name='tahun[" +i+ "][nama]' id='nama' placeholder='ex: Tahun 2023' required/></td>";
                row += `<td><div class="form-check form-switch"><input class="form-check-input" type="checkbox" role="switch" id="is_current${i}" name="tahun[${i}][is_current]" value="1"></div></td>`;
