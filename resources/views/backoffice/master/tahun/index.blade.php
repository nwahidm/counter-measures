<x-backoffice.layout.app-layout title="Master Tahun">
    @push('css')
        <style>
            thead {
                font-weight: bold;
                                ...
                                <div class="card-header border-0 pt-6">
                                    ...
                                    <div class="card-toolbar">
                                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                            <a href="{{ route('master.tahun.create') }}" class="btn btn-primary btn-sm">Tambah</a>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        function deleteData(event) {
            ...
            let url = "{{ route('master.tahun.destroy', ':id') }}";
