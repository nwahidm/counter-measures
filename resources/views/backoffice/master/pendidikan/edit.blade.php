<x-backoffice.layout.app-layout title="Ubah Pendidikan">
    <x-backoffice.toolbar heading="Ubah Pendidikan" subheading="" breadcrumb="master-pendidikan-edit" icon="fas fa-users">
                    ...
                    <div class="row g-5 g-xl-8">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="form" action="{{ route('master.pendidikan.update', $data->kode) }}" method="post" autocomplete="off">
                                        @csrf
                                        @method('PUT')
