<x-backoffice.layout.app-layout title="Tambah Pendidikan">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Tambah Pendidikan" subheading="" breadcrumb="master-pendidikan-create" icon="fas fa-users">
                    ...
                    <div class="row g-5 g-xl-8">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="form" action="{{ route('master.pendidikan.store') }}" method="post">
                                        @csrf
    ...
    <script>
        $(document).ready(function(){  
            ...
            $('#add').click(function(){  
                i++;
                row = "<tr>"
                row += "<td><input type='text' class='form-control form-control-solid' name='pendidikan[" +i+ "][kode]' id='kode' required/></td>";
                row += "<td><input type='text' class='form-control form-control-solid' name='pendidikan[" +i+ "][nama]' id='nama' required/></td>";
