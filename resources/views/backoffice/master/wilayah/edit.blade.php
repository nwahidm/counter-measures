<x-backoffice.layout.app-layout title="Ubah Wilayah">

    <x-backoffice.toolbar heading="Ubah Wilayah" subheading="" breadcrumb="master-wilayah-edit" icon="fas fa-users">
                    ...
                    <div class="row g-5 g-xl-8">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="form" action="{{ route('master.wilayah.update', ['wilayah' => $data->id_wilayah]) }}" method="post" autocomplete="off">
                                        @csrf
                                        @method('PUT')
                                        <div class="form-group mb-7">
                                            <label for="level" class="fs-6 fw-semibold mb-2 required">Level</label>
                                            <select class="form-select form-select-solid" name="level" id="level" data-control="select2" required="required">
                                            {!! optLevelWilayah() !!}
                                            </select>
