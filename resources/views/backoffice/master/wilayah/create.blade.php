<x-backoffice.layout.app-layout title="Tambah Wilayah">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Tambah Wilayah" subheading="" breadcrumb="master-wilayah-create" icon="fas fa-users">
                    ...
                    <div class="row g-5 g-xl-8">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="form" action="{{ route('master.wilayah.store') }}" method="post">
                                        @csrf
    ...
    <script>
        $(document).ready(function(){  
            var i=1;
            let optLevelWilayah = @json(optLevelWilayah());
            $('#add').click(function(){  
                i++;
                row = "<tr>"
                row += "<td><select class='form-select form-select-solid' name='data[" +i+ "][level]' id='level"+i+"' required>"+optLevelWilayah+"</select></td>";
