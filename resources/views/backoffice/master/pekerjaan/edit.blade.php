<x-backoffice.layout.app-layout title="Ubah Pekerjaan">
    <x-backoffice.toolbar heading="Ubah Pekerjaan" subheading="" breadcrumb="master-pekerjaan-edit" icon="fas fa-users">
                    ...
                    <div class="row g-5 g-xl-8">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="form" action="{{ route('master.pekerjaan.update', $data->kode) }}" method="post" autocomplete="off">
                                        @csrf
                                        @method('PUT')
