<x-backoffice.layout.app-layout title="Tambah Kasus">
    ...
    @endpush
    <x-backoffice.toolbar heading="Tambah Kasus" subheading="" breadcrumb="open-case-create" icon="fas fa-users">
                ...
                <div id="kt_app_content" class="app-content flex-column-fluid">
                    <div class="row g-5 g-xl-8">
                        <div class="col-md-12" id="formCheck">
                            <div class="card">
                                <div class="card-body">
                                    <form id="form" action="{{ route('open.case.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                                        @csrf
                                        <div class="card ">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" name="nama_kasus" id="nama_kasus" placeholder="" value="{{old('nama_kasus')}}" required="required">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="date" class="form-control" name="tanggal_kasus" id="tanggal_kasus" value="{{old('tanggal_kasus') ?? \Carbon\Carbon::now('Asia/Jakarta')->toDateString()}}"required="required">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <textarea class="form-control " name="deskripsi_kasus" type="text" rows='4'
                                                            placeholder="Lengkapi Data...">{{old('deskripsi_kasus')}}</textarea>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" name="nama_target" id="nama_target" placeholder="" value="{{old('nama_target')}}" required="required">
                                                        <p class="text-danger">{{ $errors->first('nama_target') }}</p>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="agama" class="fs-6 fw-semibold mb-2">Agama</label>
                                                        <input type="text" class="form-control" name="agama" id="agama" placeholder="" value="{{old('agama')}}" required="required">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        <label for="target_education" class="fs-6 fw-semibold mb-2">Pendidikan Terakhir</label>
                                                            <div class="form-group col-md-12">
                                                                <input type="text" class="form-control" name="pendidikan" id="pendidikan" placeholder="" value="{{old('pendidikan')}}" required="required">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="target_occupation" class="fs-6 fw-semibold mb-2">Pekerjaan</label>
                                                            <div class="form-group col-md-12">
                                                                <input type="text" class="form-control" name="pekerjaan" id="pekerjaan" placeholder="" value="{{old('pekerjaan')}}" required="required">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        <label for="target_education" class="fs-6 fw-semibold mb-2">Jenis Kelamin</label>
                                                            <div class="form-group col-md-12">
                                                                <input type="text" class="form-control" name="jenis_kelamin" id="jenis_kelamin" placeholder="" value="{{old('jenis_kelamin')}}" required="required">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <textarea type="text" class="form-control" name="alamat" id="alamat" placeholder="" value="{{old('alamat')}}" required="required"></textarea>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        <label for="no_hp_target" class="fs-6 fw-semibold mb-2">No HP Target</label>
                                                            <div class="form-group col-md-12">
                                                                <input type="text" class="form-control" name="no_hp_target" id="no_hp_target" placeholder="" value="{{old('jenis_kelamin')}}" required="required">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-12">
                                                        <label for="foto_dokumen" class="fs-6 fw-semibold mb-2">Foto Dokumen (Multiple Input Max. 2MB Per Foto)</label>
                                                        ...
                                                        <div class="foto_dokumen_preview container"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <button class="btn btn-dark waves-effect waves-classic waves-effect waves-classic" type="submit">Simpan</button>
                                    </form>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#foto_dokumen').on('change', function() {
                const input = $(this);
                const preview = $('.foto_dokumen_preview');
