<x-backoffice.layout.app-layout title="Tambah Single Form Open Case">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Tambah Single Form Open Case" subheading="" breadcrumb="open-case-create" icon="fas fa-users">
                ...
                <div id="kt_app_content" class="app-content flex-column-fluid">
                    <div class="row g-5 g-xl-8">
                        <div class="col-md-12" id="formCheck">
                            <div class="card">
                                <div class="card-body">
                                    <form id="form" action="{{ route('open.singleform.single-form.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                                        @csrf
                                        <div class="card ">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-12">
                                                        <label for="case_description" class="fs-6 fw-semibold mb-2 required">Deskripsi Kasus</label>
                                                        <textarea class="form-control form-control-solid @error('case_description') is-invalid @enderror"
                                                            name="case_description" id="case_description">{{ old('case_description') }}</textarea>
                                        ...
                                        <div class="card mb-3">
                                            <div class="card-body">
                                                ...
                                                <div class="row mb-7">
                                                    <div class="form-group col-md-12">
                                                        <label for="satker_id" class="fs-6 fw-semibold mb-2 required">Satuan Kerja</label>
                                                        <select
                                        ...
                                        <div class="card mb-3" id="research">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-6">
                                                            <label for="research_pendahuluan" class="fs-6 fw-semibold mb-2 required">Pendahuluan</label>
                                                            <textarea class="form-control form-control-solid @error('research_pendahuluan') is-invalid @enderror"
                                                                name="research_pendahuluan" id="research_pendahuluan">{{ old('research_pendahuluan') }}</textarea>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <textarea
                                                                ...
                                                                name="research_data_fakta" id="research_data_fakta">{{ old('research_data_fakta') }}</textarea>
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-6">
                                                            <label for="research_informasi_diperoleh"
                                                                class="fs-6 fw-semibold mb-2">Informasi Yang Diperoleh</label>
                                                            <textarea
                                                                class="form-control form-control-solid @error('research_informasi_diperoleh') is-invalid @enderror"
                                                                name="research_informasi_diperoleh" id="research_informasi_diperoleh">{{ old('research_informasi_diperoleh') }}</textarea>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <textarea
                                                                ...
                                                                name="research_sumber_informasi" id="research_sumber_informasi">{{ old('research_sumber_informasi') }}</textarea>
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-6">
                                                            <label for="research_tren_perkembangan"
                                                                class="fs-6 fw-semibold mb-2">Tren Perkembangan / Perkiraan</label>
                                                            <textarea
                                                                class="form-control form-control-solid @error('research_tren_perkembangan') is-invalid @enderror"
                                                                name="research_tren_perkembangan" id="research_tren_perkembangan">{{ old('research_tren_perkembangan') }}</textarea>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <textarea
                                                                ...
                                                                name="research_saran_tindak" id="research_saran_tindak">{{ old('research_saran_tindak') }}</textarea>
                                                            @error('research_saran_tindak')
                                                            <p class="text-danger">{{ $message }}</p>
                                                            @enderror
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card mb-3" id="interview">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('interview_interviewer_name') }}">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="date"
                                                                ...
                                                                value="{{ old('interview_interviewer_schedule') }}">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label for="nama_target" class="fs-6 fw-semibold mb-2">NIK</label>
                                                        <input type="text" class="form-control" name="interview_nik" id="interview_nik" placeholder="" value="{{old('interview_nik')}}" >                                                        
                                                        <br>
                                                        {{-- <div class="form-group">
                                                            <button onclick="processCekNikInterview()" id="buttonProcessNikInterview" type="button" class="btn btn-primary btn-lg btn-block">
                                                                Cari
                                                            </button>
                                                        </div> --}}
                                                    </div>
                                                    <div class="row mb-12">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid @error('interview_target_name') is-invalid @enderror"
                                                                name="interview_target_name" id="interview_target_name" value="{{ old('interview_target_name') }}">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            name="interview_gender" id="interview_gender" value="{{ old('interview_gender') }}">
                                                    ...
                                                    <div class="row mb-12">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            name="interview_occupation" id="interview_occupation" value="{{ old('interview_occupation') }}">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            name="interview_education" id="interview_education" value="{{ old('interview_education') }}">
                                                    ...
                                                    <div class="row mb-12">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            name="interview_religion" id="interview_religion" value="{{ old('interview_religion') }}">
                                                    ...
                                                    <div class="row mb-7">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea
                                                                ...
                                                                id="interview_address">{{ old('interview_address') }}</textarea>
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-6">
                                                            <label for="interview_upload_dokumen_wawancara"
                                                                class="fs-6 fw-semibold mb-2 ">Dokumen Wawancara</label>
                                                            <input
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <label for="interview_upload_video_wawancara"
                                                                class="fs-6 fw-semibold mb-2 ">Video Wawancara</label>
                                                            <input
                                                    ...
                                                    <div class="row mb-7">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <label for="interview_saran_dan_tindak_lanjut"
                                                                ...
                                                                Lanjut</label>
                                                            <textarea class="form-control form-control-solid @error('interview_saran_dan_tindak_lanjut') is-invalid @enderror"
                                                                name="interview_saran_dan_tindak_lanjut" id="interview_saran_dan_tindak_lanjut">{{ old('interview_saran_dan_tindak_lanjut') }}</textarea>
                                                    ...
                                                    <div class="row mb-7">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <label for="interview_keterangan"
                                                                class="fs-6 fw-semibold mb-2 required">Keterangan
                                                                Lanjut</label>
                                                            <textarea class="form-control form-control-solid @error('interview_keterangan') is-invalid @enderror"
                                                                name="interview_keterangan" id="interview_keterangan">{{ old('interview_keterangan') }}</textarea>
                                                            @error('interview_keterangan')
                                                            <p class="text-danger">{{ $message }}</p>
                                                            @enderror
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card mb-3" id="interrogation">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label for="interrogation_target_identity_number" class="fs-6 fw-semibold mb-2">NIK</label>
                                                        <input type="text" class="form-control" name="interrogation_target_identity_number" id="interrogation_target_identity_number" placeholder="" value="{{old('interrogation_target_identity_number')}}">                                                        
                                                        <br>
                                                        <div class="form-group">
                                                            {{-- <button onclick="processCekNikInterrogation()" id="buttonProcessNikInterrogation" type="button" class="btn btn-primary btn-lg btn-block">
                                                                Cari
                                                            </button> --}}
                                                        </div>
                                                    </div>
                                                    <div class="row mb-12">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid @error('interrogation_target_name') is-invalid @enderror"
                                                                name="interrogation_target_name" id="interrogation_target_name" value="{{ old('interrogation_target_name') }}">
                                                            @error('interrogation_target_name')
                                                            <p class="text-danger">{{ $message }}</p>
                                                            @enderror
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <label for="interrogation_gender" class="fs-6 fw-semibold mb-2">Jenis Kelamin Target</label>
                                                            <input type="text" class="form-control form-control-solid @error('interrogation_gender') is-invalid @enderror"
                                                            name="interrogation_gender" id="interrogation_gender" value="{{ old('interrogation_gender') }}">
                                                    ...
                                                    <div class="row mb-12">
                                                        <div class="form-group col-md-6">
                                                            <label for="interrog" class="fs-6 fw-semibold mb-2">Pekerjaan</label>
                                                            <input type="text" class="form-control form-control-solid @error('interrogation_occupation') is-invalid @enderror"
                                                            name="interrogation_occupation" id="interrogation_occupation" value="{{ old('interrogation_occupation') }}">
                                                            @error('interrogation_occupation')
                                                            <p class="text-danger">{{ $message }}</p>
                                                            @enderror
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <label for="interrogation_education" class="fs-6 fw-semibold mb-2">Pendidikan Terakhir</label>
                                                            <input type="text" class="form-control form-control-solid @error('interrogation_education') is-invalid @enderror"
                                                            name="interrogation_education" id="interrogation_education" value="{{ old('interrogation_education') }}">
                                                    ...
                                                    <div class="row mb-12">
                                                        <div class="form-group col-md-6">
                                                            <label for="interrogation_target_religion" class="fs-6 fw-semibold mb-2">Agama</label>
                                                            <input type="text" class="form-control form-control-solid @error('interrogation_target_religion') is-invalid @enderror"
                                                            name="interrogation_target_religion" id="interrogation_target_religion" value="{{ old('interrogation_target_religion') }}">
                                                    ...
                                                    <div class="row mb-7">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <label for="interrogation_address"
                                                                class="fs-6 fw-semibold mb-2">Alamat </label>
                                                            <textarea
                                                                class="form-control form-control-solid @error('interrogation_address') is-invalid @enderror"
                                                                name="interrogation_address"
                                                                id="interrogation_address">{{ old('interrogation_address') }}</textarea>
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-6">
                                                            <label for="interrogation_upload_dokumen_wawancara"
                                                                class="fs-6 fw-semibold mb-2 ">Dokumen Interogasi</label>
                                                            <input
                                                                class="form-control form-control-solid @error('upload_dokumen_wawancara') is-invalid @enderror"
                                                                name="interrogation_upload_dokumen_wawancara"
                                                                type="file"
                                                                id="interrogation_upload_dokumen_wawancara"
                                                                value="{{ old('interrogation_upload_dokumen_wawancara') }}">
                                                            @error('interrogation_upload_dokumen_wawancara')
                                                            <p class="text-danger">{{ $message }}</p>
                                                            @enderror
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <label for="interrogation_upload_video_wawancara"
                                                                class="fs-6 fw-semibold mb-2 ">Video Interogasi</label>
                                                            <input
                                                                class="form-control form-control-solid @error('interrogation_upload_video_wawancara') is-invalid @enderror"
                                                                name="interrogation_upload_video_wawancara"
                                                                type="file"
                                                                id="interrogation_upload_video_wawancara"
                                                                value="{{ old('interrogation_upload_video_wawancara') }}">
                                                    ...
                                                    <div class="row mb-7">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <label for="interrogation_target_identification"
                                                                class="fs-6 fw-semibold mb-2 required">Identifikasi Target
                                                                </label>
                                                            <textarea class="form-control form-control-solid @error('interrogation_target_identification') is-invalid @enderror"
                                                                name="interrogation_target_identification"
                                                                id="interrogation_target_identification">{{ old('interrogation_target_identification') }}</textarea>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <label for="interrogation_result_achievement"
                                                                class="fs-6 fw-semibold mb-2 required">Hasil yang Dicapai
                                                                </label>
                                                            <textarea class="form-control form-control-solid @error('interrogation_result_achievement') is-invalid @enderror"
                                                                name="interrogation_result_achievement"
                                                                id="interrogation_result_achievement">{{ old('interrogation_result_achievement') }}</textarea>
                                        ...
                                        <div class="card mb-3" id="elicitation">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('elicitation_interviewer_name') }}">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="date"
                                                                ...
                                                                value="{{ old('elicitation_interview_schedule') }}">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label for="elicitation_interview_target_identity_number" class="fs-6 fw-semibold mb-2">NIK</label>
                                                        <input type="text" class="form-control" name="elicitation_interview_target_identity_number" id="elicitation_interview_target_identity_number" placeholder="" value="{{old('elicitation_interview_target_identity_number')}}" >                                                        
                                                        <br>
                                                        <div class="form-group">
                                                    ...
                                                    <div class="row mb-12">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid @error('elicitation_interview_target_name') is-invalid @enderror"
                                                                name="elicitation_interview_target_name" id="elicitation_interview_target_name" value="{{ old('elicitation_interview_target_name') }}">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            name="elicitation_target_gender" id="elicitation_target_gender" value="{{ old('elicitation_target_gender') }}">
                                                    ...
                                                    <div class="row mb-12">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            name="elicitation_target_occupation" id="elicitation_target_occupation" value="{{ old('elicitation_target_occupation') }}">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            name="elicitation_target_education" id="elicitation_target_education" value="{{ old('elicitation_target_education') }}">
                                                    ...
                                                    <div class="row mb-7">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea
                                                                ...
                                                                id="elicitation_target_address">{{ old('elicitation_target_address') }}</textarea>
                                                    ...
                                                    <div class="row mb-12">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            name="elicitation_target_religion" id="elicitation_target_religion" value="{{ old('elicitation_target_religion') }}">
                                                    ...
                                                    <div class="row mb-7">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <textarea class="form-control form-control-solid @error('elicitation_pendahuluan') is-invalid @enderror"
                                                                name="elicitation_pendahuluan"
                                                                id="elicitation_pendahuluan">{{ old('elicitation_pendahuluan') }}</textarea>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <textarea class="form-control form-control-solid @error('elicitation_pelaksanaan_kegiatan') is-invalid @enderror"
                                                                name="elicitation_pelaksanaan_kegiatan"
                                                                id="elicitation_pelaksanaan_kegiatan">{{ old('elicitation_pelaksanaan_kegiatan') }}</textarea>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <textarea
                                                                ...
                                                                id="elicitation_kendala">{{ old('elicitation_kendala') }}</textarea>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <textarea
                                                                ...
                                                                id="elicitation_analisa">{{ old('elicitation_analisa') }}</textarea>
