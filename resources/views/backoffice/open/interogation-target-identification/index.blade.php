<x-backoffice.layout.app-layout title="Identifikasi Target">
    @push('css')
        <style>
            thead {
                font-weight: bold;
    ...
    @endpush
    <x-backoffice.toolbar heading="Identifikasi Target" subheading="" breadcrumb="interogation-target-identification" icon="fas fa-users">
                                ...
                                <div class="card-header border-0 pt-6">
                                    ...
                                    <div class="card-toolbar">
                                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                            <a href="{{ route('open.data.interogg-target-id.create') }}"
    ...
    @push('js')
        <script>
            function deleteData(event) {
                ...
                let url = "{{ route('open.data.interogg-target-id.destroy', ':id') }}";
