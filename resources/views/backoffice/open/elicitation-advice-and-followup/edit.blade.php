<x-backoffice.layout.app-layout title="UBAH DATA SARAN DAN TINDAK LANJUT">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="UBAH DATA SARAN DAN TINDAK LANJUT" subheading="" breadcrumb="elicitation-advice-and-followup-edit"
                          icon="fas fa-users">
                ...
                <div id="kt_app_content" class="app-content flex-column-fluid">
                    <div class="row g-5 g-xl-8">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <form id="form" action="{{ route('open.data.elicit-adfoll.update', $data->id_elicitation_saran_dan_tindak_lanjut) }}"
                                          method="post"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row mb-7">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select
                                                        class="form-select form-select-solid select @error('id_elicitation_interview_result') is-invalid @enderror"
                                                        ...
                                                        data-control="select2" data-hide-search="true">
                                                            ...
                                                            @foreach ($elinterview as $row)
                                                                <option
                                                                    ...
                                                                    @if($row['id_elicitation_interview_result'] === old('id_elicitation_interview_result', $data->elicitation_hasil_wawancara_id)) selected @endif>{{ $row['interviewer_name'] }}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input class="form-control form-control-solid" required="required"
                                                            ...
                                                            value="{{ $data->saran_dan_tindak_lanjut_date }}">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group mb-7">
                                                            ...
                                                            <textarea class="form-control ckeditor2" name="saran_tinjut" id="saran_tinjut"
                                                                rows="4">{{ $data->saran_dan_tindak_lanjut }}</textarea>
