<x-backoffice.layout.app-layout title="Tambah Catatan Interogasi">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Tambah Catatan Interogasi" subheading="" breadcrumb="interogation-record-create"
                          icon="fas fa-users">
                ...
                <div id="kt_app_content" class="app-content flex-column-fluid">
                    <div class="row g-5 g-xl-8">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <form id="form" action="{{ route('open.data.interrog-record.store') }}" method="post"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row mb-7">
                                                    <div class="form-group col-md-6">
                                                        <label for="no_surat"
                                                            ...
                                                            Perintah</label>
                                                        <input type="text"
                                                               class="form-control form-control-solid @error('no_surat') is-invalid @enderror"
                                                               name="no_surat" id="nomor_sprint"
                                                               value="{{ old('no_surat') }}">
                                                        @error('no_surat')
                                                        <p class="text-danger">{{ $message }}</p>
                                                        @enderror
                                                ...
                                                <div class="row mb-7">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select class="form-control form-control-solid select" id="pegawai" name="pegawai[]" multiple="multiple" required>
                                                ...
                                                <div class="row mb-7">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        name="born_place" id="born_place" value="{{ old('born_place') }}">
                                                        @error('born_place')
                                                        <p class="text-danger">{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        name="born_date" id="born_date" value="{{ old('born_date') }}">
                                                        @error('born_date')
                                                        <p class="text-danger">{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="row mb-7">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <textarea type="text" class="form-control" name="hasil" id="hasil" tabindex="-1" placeholder="" value="{{old('hasil', '<ol><li>Apakah pada hari ini saudara dalam keadaan sehat jasmani dan rohani serta<br>bersediakah saudara memberikan keterangan?--------------------------------------------------<br>1.</li><li>Apakah Saudara mengetahui apa sebabnya dimintai keterangan pada hari ini?-----------<br>2&nbsp;</li><li><p>Dan seterusnya sesuai kebutuhan .................................................................................<br>3.</p><p>…………………..</p></li><li>Apakah masih ada keterangan lain yang akan Saudara berikan tentang masalah tersebut<br>di atas?---------------------------------------------------------------------------------------<br>(..) ..................................................................................................…</li><li>Apakah semua keterangan yang Saudara berikan tersebut di atas benar dan diberikan<br>tanpa tekanan / ancaman dari Jaksa Penyelidik atau dari pihak lain?--------------------<br>(..) .....................................................................................................</li></ol>')}}" ></textarea>
                                                ...
                                                <div class="row mb-7">
                                                    ...
                                                    {{-- <div class="col-md-6">
                                                        <div class="form-group mb-7">
                                                            <label for="upload_berita_acara" class="fs-6 fw-semibold mb-2 ">Berita Acara (pdf)</label>
