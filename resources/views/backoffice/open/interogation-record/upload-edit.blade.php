<x-backoffice.layout.app-layout title="Upload Berita Acara Permintaan Keterangan">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Upload Berita Acara Permintaan Keterangan" subheading=""
                    ...
                    <div class="row g-5 g-xl-8">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <form id="form"
                                          action="{{ route('open.data.interrog-record-report.update-upload', $data->id_interogation_record) }}"
                                          method="post"
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <div class="input-group">
                                                            <input
                                                                ...
                                                                name="upload_berita_acara"
                                                                type="file"
                                                                id="upload_berita_acara"
                                                                value="{{ old('upload_berita_acara') }}">
                                                            @if($data->berita_acara_path)
                                                                <a class="btn btn-dark"
                                                                   href="{{ route('open.data.elicit-result.download-file', encrypt($data->berita_acara_path)) }}"
