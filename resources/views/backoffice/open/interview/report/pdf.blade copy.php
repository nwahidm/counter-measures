...
<table>
    ...
    <!-- <tr>
        <td colspan="4" class="sub-header">HASIL WAWANCARA</td>
    </tr>

    @forelse ($data->interviewHasil as $index0 => $interviewHasil)
    @php
    ...
    <tr>
        <td></td>
        <td colspan="3"><strong>{{ $alphabet }}. Informasi Hasil Wawancara ke - {{ $index0 + 1 }}</strong></td>
    </tr>
    <tr>
        <td></td>
        <td>Dokumen Wawancara</td>
        <td>:</td>
        <td>{{ $interviewHasil->upload_dokumen_wawancara }}</td>
    </tr>
    <tr>
        <td></td>
        <td>Video Wawancara</td>
        <td>:</td>
        <td>{{ $interviewHasil->upload_video_wawancara }}</td>
    </tr> -->
    {{-- End Interview Hasil --}}
    ...
    @empty
    <tr>
        <td colspan="4" style="text-align: center;">Belum ada Hasil Wawancara.</td>
    </tr>
    @endforelse
