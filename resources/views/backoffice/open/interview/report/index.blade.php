<x-backoffice.layout.app-layout title="Wawancara Report">
    @push('css')
        <style>
            thead {
                font-weight: bold;
    ...
    @endpush
    <x-backoffice.toolbar heading="Wawancara Report" subheading="" breadcrumb="interview-report" icon="fas fa-users">
