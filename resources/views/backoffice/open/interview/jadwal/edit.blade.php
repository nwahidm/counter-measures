<x-backoffice.layout.app-layout title="Ubah Interview Jadwal">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Ubah Interview Jadwal" subheading="" breadcrumb="open-interview-jadwal-create"
                          icon="fas fa-users">
                    ...
                    <div class="row g-5 g-xl-8">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <form id="form"
                                          action="{{ route('open.interview.jadwal.update', $data->id_interview_scheduler) }}"
                                          method="post"
                                        ...
                                        <div class="card ">
                                            <div class="card-body">
                                                ...
                                                <div class="row mb-7">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input type="text"
                                                               ...
                                                               value="{{ old('interview_nip', $data->interview_nip) }}">
                                                        @error('interview_nip')
                                                        <p class="text-danger">{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="row mb-7">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text"
                                                               ...
                                                               value="{{ old('interviewer_name', $data->interviewer_name) }}">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text"
                                                               ...
                                                               value="{{ old('interviewer_name', $data->interview_jabatan) }}">
                                                ...
                                                <div class="row mb-7">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text"
                                                               ...
                                                               value="{{ old('interviewer_name', $data->interview_pangkat) }}">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="interviewer_schedule"
                                                               class="fs-6 fw-semibold mb-2">Jadwal
                                                            Pewawancara</label>
                                                        <input type="date"
                                                               ...
                                                               value="{{ old('interviewer_schedule', $data->interviewer_schedule?->toDateString()) }}">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" name="target_identity_number" id="target_identity_number" placeholder="" value="{{old('target_identity_number',$data->target_identity_number)}}" required="required">                                                        
                                                    <br>
                                                    <div class="form-group">
                                                ...
                                                <div class="row mb-12">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control form-control-solid @error('source_person_name') is-invalid @enderror"
                                                               name="source_person_name" id="source_person_name" value="{{ old('source_person_name', $data->source_person_name) }}">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        name="target_gender" id="target_gender" value="{{ old('target_gender', $data->target_gender) }}">
                                                        @error('target_gender')
                                                        <p class="text-danger">{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="row mb-12">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        name="target_occupation" id="target_occupation" value="{{ old('target_occupation', $data->target_occupation) }}">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        name="target_education" id="target_education" value="{{ old('target_education', $data->target_education) }}">
                                                ...
                                                <div class="row mb-12">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        name="target_religion" id="target_religion" value="{{ old('target_religion', $data->target_religion) }}">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        name="target_alamat" id="alamat" value="{{ old('target_alamat', $data->target_alamat) }}">
                                                        @error('target_alamat')
                                                        <p class="text-danger">{{ $message }}</p>
                                                        @enderror
                                                    </div>
