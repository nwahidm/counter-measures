<x-backoffice.layout.app-layout title="Ubah Wawancara Saran Tindak Lanjut">
    @push('css')
    <style>
        thead {
            background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Ubah Wawancara Saran Tindak Lanjut" subheading=""
        breadcrumb="open-interview-saran_tl-edit" icon="fas fa-users">
                    ...
                    <div class="row g-5 g-xl-8">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <form id="form"
                                        action="{{ route('open.interview.saran_tl.update', $data->id_interview_advice_and_follow_up) }}"
                                                ...
                                                <div class="row mb-7">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach ($case as $row)
                                                            <option value="{{ $row['id'] }}"
                                                                @if($row['id']===old('id_case', $data->case_id)) selected
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="interview_schedule_id"
                                                        ...
                                                        <select
                                                            ...
                                                            <option value="{{ $row['id'] }}"
                                                                @if($row['id']===old('interview_schedule_id', $data->interview_schedule_id)) selected
                                                                @endif>{{ $row['text']
                                                                }}</option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="row mb-7">
                                                    <div class="form-group col-md-6">
                                                        <label for="interview_result_id"
                                                            class="fs-6 fw-semibold mb-2">Hasil
                                                            Wawancara</label>
                                                        <select
                                                            ...
                                                            data-control="select2" data-hide-search="true">
                                                            <option value="">---Pilih Hasil Wawancara---</option>
                                                            @foreach ($hasil as $row)
                                                            <option value="{{ $row['id'] }}"
                                                                @if($row['id']===old('interview_result_id', $data->
                                                                interview_result_id)) selected @endif>{{ $row['text'] }}
                                                            </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="date"
                                                            ...
                                                            value="{{ old('saran_dan_tindak_lanjut_date', $data->saran_dan_tindak_lanjut_date?->toDateString()) }}">
                                                ...
                                                <div class="row mb-7">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <textarea
                                                            ...
                                                            id="saran_dan_tindak_lanjut">{{ old('saran_dan_tindak_lanjut', $data->saran_dan_tindak_lanjut) }}</textarea>
