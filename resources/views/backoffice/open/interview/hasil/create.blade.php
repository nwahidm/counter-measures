<x-backoffice.layout.app-layout title="Tambah Wawancara Hasil">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Tambah Wawancara Hasil" subheading="" breadcrumb="open-interview-hasil-create"
                          icon="fas fa-users">
                ...
                <div id="kt_app_content" class="app-content flex-column-fluid">
                    <div class="row g-5 g-xl-8">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <form id="form" action="{{ route('open.interview.hasil.store') }}" method="post"
                                        ...
                                        <div class="card ">
                                            <div class="card-body">
                                                ...
                                                <div class="row mb-12">
                                                    <div class="form-group col-md-12">
                                                        <label for="keterangan" class="fs-6 fw-semibold mb-2">Keterangan</label>
                                                        <textarea class="form-control form-control-solid @error('keterangan') is-invalid @enderror"
