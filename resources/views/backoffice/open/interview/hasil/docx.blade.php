...
<table align="center" border="0" style="width: 100%;">
    <tr>
        ...
        @if($data->case->satker->tipe_satker == '4')
            <td valign="top" align="center"  style="font-size:22"><strong> KEJAKSAAN REPUBLIK INDONESIA <br>{{ $data->satker->nama_satker }}</br> </strong></td>
        @elseif($data->case->tipe_satker == '3')
            <td valign="top" align="center"  style="font-size:22"><strong> KEJAKSAAN REPUBLIK INDONESIA <br>{{ $data->satker->nama_satker }}</br>  </strong></td>
        @elseif($data->case->tipe_satker == '2')
            <td valign="top" align="center"  style="font-size:22"><strong> KEJAKSAAN REPUBLIK INDONESIA <br>{{ $data->satker->nama_satker }}</br> </strong></td>
        @else
            <td valign="top" align="center"  style="font-size:22"><strong> KEJAKSAAN REPUBLIK INDONESIA <br>KEJAKSAAN AGUNG</br> </strong></td>
        @endif
    </tr>
...
<table>
    <tr>
        <td colspan="4" class="header">
            LAPORAN WAWANCARA (AUDIO KE TEKS)
        </td>
    </tr>
    <tr>
