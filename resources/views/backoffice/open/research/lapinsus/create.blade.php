<x-backoffice.layout.app-layout title="Tambah Penelitian Laporan Informasi Khusus">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Tambah Penelitian Laporan Informasi Khusus" subheading=""
                ...
                <div id="kt_app_content" class="app-content flex-column-fluid">
                    <div class="row g-5 g-xl-8">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <form id="form" action="{{ route('open.research.spesific-intel-report.store') }}"
                                          method="post"
                                                ...
                                                <div class="row mb-7">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <textarea
                                                            ...
                                                            name="informasi_diperoleh" id="informasi_diperoleh">{{ old('pendahuluan') }}</textarea>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <textarea
                                                            ...
                                                            name="sumber_informasi" id="sumber_informasi">{{ old('sumber_informasi') }}</textarea>
                                                ...
                                                <div class="row mb-7">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <textarea
                                                            ...
                                                            name="tren_perkembangan" id="tren_perkembangan">{{ old('tren_perkembangan') }}</textarea>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <textarea
                                                            ...
                                                            name="saran_tindak" id="saran_tindak">{{ old('saran_tindak') }}</textarea>
                                                        @error('saran_tindak')
                                                        <p class="text-danger">{{ $message }}</p>
                                                        @enderror
                                                    </div>
