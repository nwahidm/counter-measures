<x-backoffice.layout.app-layout title="Detail Penelitian Potensi Ancamam, Gangguan, dan Hambatan">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Detail Penelitian Potensi Ancamam, Gangguan, dan Hambatan" subheading="" breadcrumb="open-case-detail"
                          icon="fas fa-users">
                                    ...
                                    <div class="card ">
                                        <div class="card-body">
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                            class="fw-bold fs-6 text-gray-800">{{ $data->case->satker->nama_satker }}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                        <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify;">{{ optional($data->case)->tanggal_kasus->isoFormat('DD MMMM YYYY') }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-10">
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                            class="fw-bold fs-6 text-gray-800" style="text-align: justify;">{{ optional($data->researchSuratPerintah)->surat_perintah_date?->isoFormat('DD MMMM YYYY') }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    @if (optional($data->researchSuratPerintah)->surat_perintah_path)
                                                        <iframe style="width: 100%; height: 500px; overflow: hidden;" src="{{ asset('storage/'. $data->researchSaranTindakLanjut->researchLaporanInformasiKhusus->researchSuratPerintah->surat_perintah_path) }}" frameborder="0" id="file_surat_perintah">
                                                        </iframe>
                                                    @else
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                            class="fw-bold fs-6 text-gray-800" style="text-align: justify;">{{ $data->researchLaporanInformasiKhusus->nomor_surat ??''}}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                            ...
                                            <div class="row mb-5">
                                                <label class="col-lg-4 fw-semibold text-muted" style="text-align: justify;">Tgl. Surat
                                                    Perintah</label>
                                                <div class="col-lg-8">
                                                    <span class="fw-bold fs-6 text-gray-800">
                                                        {{ optional(optional($data->researchLaporanInformasiKhusus)->tanggal_surat)->isoFormat('DD MMMM YYYY') ?? '' }}
                                                    </span>
                                            ...
                                            <div class="row mb-10">
                                                ...
                                                <div class="col-lg-8">
                                                    @if (optional($data->researchLaporanInformasiKhusus)->file_laporan_informasi_khusus)
                                                        <iframe style="width: 100%; height: 500px; overflow: hidden;" src="{{ asset('storage/'. $data->researchSaranTindakLanjut->researchLaporanInformasiKhusus->file_laporan_informasi_khusus) }}" frameborder="0" id="file_laporan_informasi_khusus">
                                                        </iframe>
                                                    @else
                                                        <label class="col-lg-4 fw-semibold text-muted mb-3">Tidak Ada File</label>
                                                    @endif
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span class="fw-bold fs-6 text-gray-800" style="text-align: justify;">
                                                        {{ optional(optional($data->researchSaranTindakLanjut)->saran_dan_tindak_lanjut_date)->isoFormat('DD MMMM YYYY') ?? '' }}
                                                    </span>
                                            ...
                                            <div class="row mb-10">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                            class="fw-bold fs-6 text-gray-800" style="text-align: justify;">{{ strip_tags($data->researchSaranTindakLanjut->saran_dan_tindak_lanjut ??'') }}</span>
                                                </div>
                                            </div>

                                            <label class="fs-3 fw-bold">DETAIL POTENSI ANCAMAN, GANGGUAN, HAMBATAN, DAN TANTANGAN:</label> <hr>
                                           
                                            <div class="row mb-5">
                                                <label class="col-lg-4 fw-semibold text-muted">Waktu</label>
                                                <div class="col-lg-8">
                                                    <span
                                                            class="fw-bold fs-6 text-gray-800" style="text-align: justify;">{{ strip_tags($data->waktu?->isoFormat('DD MMMM YYYY')) }}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-10">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                            class="fw-bold fs-6 text-gray-800" style="text-align: justify;">{{ strip_tags($data->ancaman) }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-10">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                            class="fw-bold fs-6 text-gray-800" style="text-align: justify;">{{ strip_tags($data->gangguan) }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-10">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                            class="fw-bold fs-6 text-gray-800" style="text-align: justify;">{{ strip_tags($data->hambatan) }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-10">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                            class="fw-bold fs-6 text-gray-800" style="text-align: justify;">{{ strip_tags($data->tantangan) }}</span>
                                                </div>
                                            </div>
