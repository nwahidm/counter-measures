<x-backoffice.layout.app-layout title="Ubah Penelitian Saran dan Tindak Lanjut">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Ubah Penelitian Saran dan Tindak Lanjut" subheading=""
                    ...
                    <div class="row g-5 g-xl-8">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <form id="form"
                                          action="{{ route('open.research.advice-measure.update', $data->id_saran_dan_tindak_lanjut) }}"
                                          method="post"
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach ($satker as $row)
                                                                <option
                                                                    value="{{ $row['id'] }}"
                                                                    @if($row['id'] === $data?->case?->satker?->id_satker) selected @endif>{{ $row['text'] }}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('id_satker')
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach ($sprint as $row)
                                                                <option
                                                                    value="{{ $row['id'] }}"
                                                                    @if($row['id'] === old('id_sprint', $data->researchSuratPerintah->id_surat_perintah??'')) selected @endif>{{ $row['text'] }}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('id_sprint')
                                                        <p class="text-danger">{{ $message }}</p>
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach ($lik as $row)
                                                                <option
                                                                    value="{{ $row['id'] }}"
                                                                    @if($row['id'] === old('id_lapinsus', $data->laporan_informasi_khusus_id)) selected @endif>{{ $row['text'] }}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('id_lapinsus')
                                                        <p class="text-danger">{{ $message }}</p>
                                                ...
                                                <div class="row mb-7">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="date"
                                                               ...
                                                               value="{{ old('tanggal_tl', $data->saran_dan_tindak_lanjut_date?->toDateString()) }}">
                                                        @error('tanggal_tl')
                                                        <p class="text-danger">{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <textarea
                                                            ...
                                                            name="saran_tl" id="saran_tl">{{ old('saran_tl', $data->saran_dan_tindak_lanjut) }}</textarea>
                                                        @error('saran_tl')
                                                        <p class="text-danger">{{ $message }}</p>
                                                        @enderror
                                                    </div>
