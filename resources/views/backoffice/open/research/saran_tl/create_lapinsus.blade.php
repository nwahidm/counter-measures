                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach ($satker as $row)
                                                                <option
                                                                    value="{{ $row['id'] }}"
                                                                    @if($row['id'] == $lapinsus->satker_id) selected @endif>{{ $row['text'] }}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('id_satker')
                                                ...
                                                <div class="row mb-7">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach ($case as $row)
                                                                <option
                                                                    value="{{ $row['id'] }}"
                                                                    @if($row['id'] === old('id_case', $lapinsus->case_id)) selected @endif>{{ $row['text'] }}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('id_case')
                                                        <p class="text-danger">{{ $message }}</p>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach ($listSprint as $row)
                                                                <option
                                                                    value="{{ $row['id'] }}"
                                                                    @if($row['id'] === old('id_sprint', $lapinsus->surat_perintah_id)) selected @endif>{{ $row['text'] }}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('id_sprint')
                                                        <p class="text-danger">{{ $message }}</p>
                                                ...
                                                <div class="row mb-7">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach ($listLapinsus as $row)
                                                                <option
                                                                    value="{{ $row['id'] }}"
                                                                    @if($row['id'] === old('id_lapinsus', $lapinsus->id)) selected @endif>{{ $row['text'] }}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('id_lapinsus')
                                                        <p class="text-danger">{{ $message }}</p>
