<html>
        ...
        <table border="0" width="100%">
            <tr>
                <td valign="top">
                    ...
                    <font style="font-size:12;text-decoration: underline;">{{ $data->satker->nama_satker }} </font>
                </td>
    ...
    <table border="0" style="Times New Roman, Times, serif; font-size:12;" width="100%" cellpadding="3" cellspacing="6" >
        ...
        <tr >
            ...
            {{ strip_tags($elicitationResult->pendahuluan) }}
            </td>
        </tr>
        ...
        <tr>
            ...
            <td width="95%" style="text-align: justify;
            text-justify: inter-word; ">
            {!! strip_tags($elicitationResult->pelaksanaan_kegiatan) !!}
            </td>
        </tr>
        ...
        <tr>
            ...
            <td width="95%" style="text-align: justify;
            text-justify: inter-word; ">
            {!! strip_tags($elicitationResult->kendala) !!}
            </td>
        </tr>
        ...
        <tr>
            <td width="5%"></td>
            <td width="95%" style="">
            {!! strip_tags($elicitationResult->analisa) !!}
            </td>
        </tr>
        ...
        <tr>
            ...
            <ol>
                <li style="">Kesimpulan <br>
                    ...
                    {!! $elicitationResult->kesimpulan !!}</li>
                <li style="">Saran <br>
                    {!! $elicitationResult->saran !!}
                </li>
            </ol>
            </td>
        </tr>
        ...
        <table border='0' autosize="1" width=100% cellpadding="0" cellspacing="0" style=" font-family:Bookman Old Style; font-size:12;">
            <tr>
                <td width=50%></td>
                <td width=50% style="text-align: center;">{{$data->satker->city}}, {{ \Carbon\Carbon::parse($elicitationResult->created_at)->translatedFormat('d F Y') }}
                </td>
            </tr>
            <tr>
                <td colspan="2"><br></td>
            ...
            <tr>
                ...
                <td width="80%">
                    ...
                    Atas LAPHASTUG No. R-LAPHASTUG-    Tgl.{{ \Carbon\Carbon::parse($elicitationResult->created_at)->translatedFormat('d F Y') }}: <br>
                    {!!$elicitationResult->petunjuk_pimpinan!!}<br><br>
                        <br><table border='0' autosize="1" width=100% cellpadding="0" cellspacing="0" style=" font-family:Bookman Old Style; font-size:12;">
                                <tr>
                                    <td width=50%></td>
                                    <td width=50% style="text-align: center;">Dikeluarkan di {{$data->satker->city}}</td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td style="text-align: center;">Pada tanggal {{ \Carbon\Carbon::parse($elicitationResult->created_at)->translatedFormat('d F Y') }}</td>
                                </tr>
                                <tr>
                                    <td colspan="2"><br></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td style="text-align: center;">JAM INTEL/ KAJATI/ KAJARI/ KACABJARI</td>
                                </tr>
                                <tr>
