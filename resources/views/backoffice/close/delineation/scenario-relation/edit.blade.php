<x-backoffice.layout.app-layout title="Ubah Delineation Scenario Relation">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Ubah Delineation Scenario Relation" subheading=""
                ...
                <div id="kt_app_content" class="app-content flex-column-fluid">
                    <div class="row g-5 g-xl-8">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <form id="form" action="{{ route('close.delineation.scenario-relation.update', $data->id) }}"
                                          method="post"
                                                ...
                                                <div class="row mb-7">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <select
                                                            ...
                                                            @if($data->information_collection_id)
                                                                @foreach ($information_verification as $row)
                                                                    <option
                                                                        value="{{ $row['id'] }}"
                                                                        @if($row['id'] === old('id_information_verification',$data->information_verification_id)) selected @endif>{{ $row['text'] }}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                        @error('id_sprint')
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <select
                                                            ...
                                                            @if($data->information_verification_id)
                                                                @foreach ($information_validation as $row)
                                                                    <option
                                                                        value="{{ $row['id'] }}"
                                                                        @if($row['id'] === old('id_information_validation',$data->information_validation_id)) selected @endif>{{ $row['text'] }}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                        @error('id_sprint')
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="text"
                                                               ...
                                                               value="{{ old('subjek_utama',$data->subjek_utama) }}">
                                                        @error('subjek_utama')
                                                        <p class="text-danger">{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="row mb-7">
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="text"
                                                               ...
                                                               value="{{ old('subjek_terkait',$data->subjek_terkait) }}">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="text"
                                                               ...
                                                               value="{{ old('jenis_relasi',$data->jenis_relasi) }}">
                                                        @error('jenis_relasi')
                                                        <p class="text-danger">{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="text"
                                                               ...
                                                               value="{{ old('kekuatan_relasi',$data->kekuatan_relasi) }}">
                                                ...
                                                <div class="row mb-7">
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="date"
                                                               ...
                                                               value="{{ old('tanggal_pencatatan',$data->tanggal_pencatatan) }}">
                                                ...
                                                <div class="row mb-7">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <textarea
                                                            ...
                                                            name="detail_relasi" id="detail_relasi">{{ old('detail_relasi',$data->detail_relasi) }}</textarea>
                                                        @error('detail_relasi')
                                                        <p class="text-danger">{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <textarea
                                                            ...
                                                            name="dampak_potensial" id="dampak_potensial">{{ old('dampak_potensial',$data->dampak_potensial) }}</textarea>
                                                ...
                                                <div class="row mb-7">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <textarea
                                                            ...
                                                            name="catatan_analisa" id="catatan_analisa">{{ old('catatan_analisa',$data->catatan_analisa) }}</textarea>
