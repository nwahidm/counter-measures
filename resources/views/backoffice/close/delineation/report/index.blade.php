<x-backoffice.layout.app-layout title="Delineation Report Module">
    @push('css')
        <style>
            thead {
                font-weight: bold;
    ...
    @endpush
    <x-backoffice.toolbar heading="Delineation Report" subheading="" breadcrumb="research-warrant" icon="fas fa-users">
