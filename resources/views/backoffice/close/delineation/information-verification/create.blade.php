<x-backoffice.layout.app-layout title="Tambah Verifikasi Informasi">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Tambah Verifikasi Informasi" subheading=""
                ...
                <div id="kt_app_content" class="app-content flex-column-fluid">
                    <div class="row g-5 g-xl-8">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <form id="form" action="{{ route('close.delineation.information-verification.store') }}"
                                          method="post"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row mb-7">
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="text"
                                                               class="form-control form-control-solid @error('kredibilitas_sumber') is-invalid @enderror"
                                                ...
                                                <div class="row mb-7">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <textarea
                                                            ...
                                                            name="detail_informasi_verifikasi" id="detail_informasi_verifikasi">{{ old('pendahuluan') }}</textarea>
                                                            @error('pendahuluan')
                                                            <p class="text-danger">{{ $message }}</p>
                                                            @enderror
                                                    </div>
