<x-backoffice.layout.app-layout title="Ubah Delineation Information Validation">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Ubah Delineation Information Validation" subheading=""
                ...
                <div id="kt_app_content" class="app-content flex-column-fluid">
                    <div class="row g-5 g-xl-8">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <form id="form" action="{{ route('close.delineation.information-validation.update', $data->id) }}"
                                          method="post"
                                                ...
                                                <div class="row mb-7">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="text"
                                                               ...
                                                               value="{{ old('metode_validasi', $data->metode_validasi) }}">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="date"
                                                               ...
                                                               value="{{ old('validation_date', $data->tanggal_validasi) }}">
                                                ...
                                                <div class="row mb-7">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <textarea
                                                            ...
                                                            name="hasil_validasi" id="hasil_validasi">{{ old('hasil_validasi', $data->hasil_validasi) }}</textarea>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <textarea
                                                            ...
                                                            name="catatan_validasi" id="catatan_validasi">{{ old('catatan_validasi', $data->catatan_validasi) }}</textarea>
