<x-backoffice.layout.app-layout title="Ubah Kasus">
    ...
    <x-backoffice.toolbar heading="Ubah Kasus" subheading="" breadcrumb="close-case-edit" icon="fas fa-users">
                    ...
                    <div class="row g-5 g-xl-8">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="form" action="{{ route('close.case.update', $data->id) }}" method="post" autocomplete="off" enctype="multipart/form-data" autocomplete="off">
                                        @csrf
                                        @method('PUT')
                                        <div class="card ">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" name="nama_kasus" id="nama_kasus" placeholder="" value="{{$data->case_name}}" required="required">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="date" class="form-control" name="tanggal_kasus" id="tanggal_kasus" value="{{$data->case_date?->isoFormat('YYYY-MM-DD') ?? \Carbon\Carbon::now('Asia/Jakarta')->toDateString()}}"required="required">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <textarea class="form-control " name="deskripsi_kasus" id="deskripsi_kasus" type="text" rows='4'
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" name="nama_target" id="nama_target" placeholder="" value="{{$data->target_name}}" required="required">
                                                        <p class="text-danger">{{ $errors->first('nama_target') }}</p>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="agama" class="fs-6 fw-semibold mb-2">Agama</label>
                                                        <input type="text" class="form-control" name="agama" id="agama" placeholder="" value="{{$data->target_religion}}" required="required">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        <label for="target_education" class="fs-6 fw-semibold mb-2">Pendidikan Terakhir</label>
                                                            <div class="form-group col-md-12">
                                                                <input type="text" class="form-control" name="pendidikan" id="pendidikan" placeholder="" value="{{$data->target_education}}" required="required">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="target_occupation" class="fs-6 fw-semibold mb-2">Pekerjaan</label>
                                                            <div class="form-group col-md-12">
                                                                <input type="text" class="form-control" name="pekerjaan" id="pekerjaan" placeholder="" value="{{$data->target_occupation}}" required="required">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        <label for="target_education" class="fs-6 fw-semibold mb-2">Jenis Kelamin</label>
                                                            <div class="form-group col-md-12">
                                                                <input type="text" class="form-control" name="jenis_kelamin" id="jenis_kelamin" placeholder="" value="{{$data->target_gender}}" required="required">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <textarea type="text" class="form-control" name="alamat" id="alamat" placeholder="" value="{{$data->target_address}}" required="required"></textarea>
    ...
    <script type="module">
        // CKEDITOR SETTING
        ClassicEditor
            .create(document.querySelector('#deskripsi_kasus'),{
                            ckfinder: {
