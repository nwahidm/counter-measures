<x-backoffice.layout.app-layout title="Tambah Kasus">
    ...
    @endpush
    <x-backoffice.toolbar heading="Tambah Kasus Tertutup" subheading="Tambahkan data detail terkait dengan metode tertutup" breadcrumb="close-case-create" icon="fas fa-users">
                ...
                <div id="kt_app_content" class="app-content flex-column-fluid">
                    <div class="row g-5 g-xl-8">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <form id="form" action="{{ route('close.case.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                                        @csrf
                                        <div class="card ">
                                            <div class="card-body">
