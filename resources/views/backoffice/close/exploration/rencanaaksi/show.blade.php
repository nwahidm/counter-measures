<x-backoffice.layout.app-layout title="Detail Penjajakan Rencana Aksi">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Detail Penjajakan Rencana Aksi" subheading=""
                          breadcrumb="open-case-detail"
                          icon="fas fa-users">
                                    ...
                                    <div class="card ">
                                        <div class="card-body">
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ strip_tags($data->rencana_aksi_data) }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ strip_tags($data->rencana_aksi_detail) }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    @if ($data->rencana_aksi_upload)
                                                        <iframe style="width: 100%; height: 500px; overflow: hidden;"
                                                            src="{{ asset('storage/' . $data->rencana_aksi_upload) }}"
                                            ...
                                            <div class="row mb-5">
                                                <label class="col-lg-4 fw-semibold text-muted"> Kesimpulan Dokumen</label>
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ $summary->doc_summary_2 }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                                <label class="col-lg-4 fw-semibold text-muted"> Analisis Dokumen</label>
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ $summary->doc_analytics_2 }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
