<x-backoffice.layout.app-layout title="Tambah Penjajakan Rencana Aksi">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Tambah Penjajakan Rencana Aksi" subheading=""
                ...
                <div id="kt_app_content" class="app-content flex-column-fluid">
                    <div class="row g-5 g-xl-8">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <form id="form" action="{{ route('close.exploration.rencana-aksi.store') }}"
                                          method="post"
                                        ...
                                        <div class="card ">
                                            <div class="card-body">
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach ($case as $row)
                                                                <option value="{{ $row->case_id }}"
                                                                    @if($row->case_id === old('case_id')) selected @endif>{{ $row->case_name }} - {{ $row->case_date }}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('case_id')
                                                        <p class="text-danger">{{ $message }}</p>
                                                ...
                                                <div class="row mb-7">
                                                    <div class="form-group col-md-6">
                                                        <label for="rencana_aksi_data" class="fs-6 fw-semibold mb-2 required">Rencana Aksi</label>
                                                        <input type="text" class="form-control form-control-solid @error('rencana_aksi_data') is-invalid @enderror"
                                                            name="rencana_aksi_data" id="rencana_aksi_data" value="{{ old('rencana_aksi_data') }}">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <textarea
                                                            ...
                                                            name="rencana_aksi_detail" id="rencana_aksi_detail">{{ old('rencana_aksi_detail') }}</textarea>
                                                ...
                                                <div class="row mb-7">
                                                    <div class="form-group col-md-4">
                                                        <label for="rencana_aksi_upload" class="fs-6 fw-semibold mb-2 required">Upload File Rencana Aksi</label>
                                                        <input class="form-control form-control-solid @error('rencana_aksi_upload') is-invalid @enderror"
                                                            name="rencana_aksi_upload" type="file" id="rencana_aksi_upload" value="{{ old ('rencana_aksi_upload') }}" accept="application/pdf">
