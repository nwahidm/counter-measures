<x-backoffice.layout.app-layout title="Detail Infiltration Dinamika Target">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Detail Infiltration Dinamika Target" subheading="" breadcrumb="open-case-detail"
        icon="fas fa-users">
                                    ...
                                    <div class="card ">
                                            ...
                                            <div class="card-toolbar">
                                                <div class="d-flex justify-content-end w-100 gap-2"
                                                    ...
                                                    <button type="button" class="btn btn-dark btn-sm"
                                                        onclick="window.location.href='{{ route('close.infiltration.target-dynamics.download-interview-audio-to-text-file', encrypt($data->id)) }}'">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ $case->case_date?->isoFormat('DD MMMM YYYY') }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-10">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{!! $case->case_description !!}</span>
                                                </div>
                                            </div>


                                            <label class="fs-3 fw-bold">DETAIL OPERASI RAHASIA:</label>
                                            <hr>
                                            <div class="row mb-5">
                                                <label class="col-lg-4 fw-semibold text-muted">Nama Operasi
                                                    Rahasia</label>
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ $infiltration_operasi_rahasia?->nama_operasi_rahasia }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                                <label class="col-lg-4 fw-semibold text-muted">Tanggal Operasi
                                                    Rahasia</label>
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ $infiltration_operasi_rahasia?->tanggal_operasi_rahasia }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ $infiltration_operasi_rahasia?->metode_eksekusi }}</span>
                                                </div>
                                            </div>


                                            <label class="fs-3 fw-bold">DETAIL DINAMIKA TARGET:</label>
                                            <hr>
                                            <div class="row mb-5">
                                                <label class="col-lg-4 fw-semibold text-muted">Dinamika Teramati</label>
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ $data->dinamika_teramati }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                                <label class="col-lg-4 fw-semibold text-muted">Tanggal Dinamika
                                                    Teramati</label>
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ $data->tanggal_dinamika_teramati }}</span>
                                                </div>
                                            </div>

                                            <div class="row mb-5">
                                                <label class="col-lg-4 fw-semibold text-muted">Deskripsi Dinamika
                                                    Teramati</label>
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ strip_tags($data->deskripsi_dinamika_teramati) }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                                <label class="col-lg-4 fw-semibold text-muted mb-3">Download File
                                                    Dokumen</label>
                                                <div class="col-lg-8">
                                                    <iframe src="{{ $data->dinamika_target_dokumen_upload }}"
                                                        style="width: 100%; height: 500px;" frameborder="0">
                                                    </iframe>
                                                </div>
                                            </div>

                                            <label class="fs-8 fw-bold">Analisa Dokumen PDF:</label>
                                            <hr>
                                            ...
                                            <label class="fs-3 fw-bold">BERKAS VIDEO:</label>
                                            <hr>
                                            <div class="row mb-5">
                                                <label class="col-lg-4 fw-semibold text-muted mb-3">Watch Video</label>
                                                <div class="col-lg-8">
                                                    <video controls style="width: 100%; height: 500px;">
                                                        <source src="{{$data->dinamika_target_video_upload }}"
                                                            do-not-allow="autoplay" frameborder="0"
                                                            style="width: 100%; height: 500px;" allowfullscreen>
                                                    </video>
                                                </div>
                                            </div>
                                            <label class="fs-8 fw-bold">Analisa Dokumen Video:</label>
                                            <hr>
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.device_dahua_id) {
                            ...
                            var fileName = "infiltration_target_dynamics_" + timestamp + "_" + uuid;
                            // Dynamically construct the channelId and playerUrl using JavaScript
        ...
        document.getElementById('stopRecordButton').addEventListener('click', () => {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $.ajax({
                        url: '/open/infiltration/target-dynamics/upload-video',
                        type: 'POST',
                        headers: {
