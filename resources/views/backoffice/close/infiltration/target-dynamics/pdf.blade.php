...
<table>
    <tr>
        <td colspan="4" class="header">
            LAPORAN PEMBUNTUTAN DINAMIKA TARGET (AUDIO KE TEKS)
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="4" class="sub-header">DATA OPERASI RAHASIA</td>
    </tr>
    <tr>
        <td width="10%"></td>
        <td width="30%">Nama Operasi</td>
        <td width="5%">:</td>
        <td>{{ $data->nama_operasi_rahasia }}</td>
    </tr>
    <tr>
        <td width="10%"></td>
        <td width="30%">Tanggal Operasi Rahasia</td>
        <td width="5%">:</td>
        <td>{{  \Carbon\Carbon::parse($data->tanggal_operasi_rahasia)->translatedFormat('d F Y') }}</td>
    </tr>
    <tr>
        <td></td>
        <td>Metode Eksekusi</td>
        <td>:</td>
        <td>{{ $data->metode_eksekusi }}</td>
    </tr>
