<x-backoffice.layout.app-layout title="Detail Delineation Report">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Detail Delineation Report" subheading="" breadcrumb="open-case-detail"
                          icon="fas fa-users">
                                    ...
                                    <div class="card ">
                                        <div class="card-body">
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ strip_tags($observation_information_collection->information_collection_source) }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ strip_tags($observation_information_collection->information_collection_date) }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ strip_tags($observation_information_collection->information_collection_detail) }}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ strip_tags($delineation_information_validation->metode_validasi) }}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ strip_tags($delineation_information_validation->catatan_validasi) }}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ strip_tags($delineation_information_validation->hasil_validasi) }}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ strip_tags($delineation_scenario_relation->subjek_utama) }}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ strip_tags($delineation_scenario_relation->subjek_terkait) }}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ strip_tags($delineation_scenario_relation->jenis_relasi) }}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ strip_tags($delineation_scenario_relation->detail_relasi) }}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ strip_tags($delineation_scenario_relation->kekuatan_relasi) }}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ strip_tags($delineation_scenario_relation->dampak_potensial) }}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ strip_tags($delineation_scenario_relation->catatan_analisa) }}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ strip_tags($delineation_scenario_relation->tanggal_pencatatan) }}</span>
                                                </div>
                                            </div>
