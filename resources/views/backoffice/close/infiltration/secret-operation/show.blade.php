<x-backoffice.layout.app-layout title="Detail Infiltration Operasi Rahasia">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Detail Infiltration Operasi Rahasia" subheading="" breadcrumb="open-case-detail"
        icon="fas fa-users">
                                    ...
                                    <div class="card-toolbar">
                                        <div class="d-flex justify-content-end w-100 gap-2"
                                            ...
                                            <button type="button" class="btn btn-dark btn-sm"
                                                onclick="window.location.href='{{ route('close.infiltration.secret-operation.download-interview-audio-to-text-file', encrypt($data->id)) }}'">
                                    ...
                                    <div class="card ">
                                        <div class="card-body">
                                            ...
                                            <div class="row mb-10">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{strip_tags($case->case_description) }}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ $data->nama_operasi_rahasia }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ $data->tanggal_operasi_rahasia }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ $data->metode_eksekusi }}</span>
                                                </div>
                                            </div>

                                            <label class="fs-3 fw-bold">BERKAS PDF:</label>
                                            <hr>
                                            <div class="row mb-5">
                                                <label class="col-lg-4 fw-semibold text-muted mb-3">Download File
                                                    Dokumen</label>
                                                <div class="col-lg-8">
                                                    <iframe src="{{ $data->operasi_rahasia_dokumen_upload }}"
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <video controls style="width: 100%; height: 500px;">
                                                        <source src="{{$data->operasi_rahasia_video_upload }}"
                                            ...
                                            <!-- <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <a class="btn btn-dark btn-sm btn-icon" href="{{ route('close.infiltration.secret-operation.download-file', encrypt($data->operasi_rahasia_video_upload)) }}">
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.device_dahua_id) {
                            ...
                            var fileName = "infiltration_secret_operation_" + timestamp + "_" + uuid;
                            // Dynamically construct the channelId and playerUrl using JavaScript
        ...
        document.getElementById('stopRecordButton').addEventListener('click', () => {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $.ajax({
                        url: '/open/infiltration/secret-operation/upload-video',
                        type: 'POST',
                        headers: {
