<x-backoffice.layout.app-layout title="Detail Penyadapan Sinyal Pintar">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Detail Penyadapan Sinyal Pintar" subheading="" breadcrumb="close-case-detail"
        icon="fas fa-users">
                                    ...
                                    <div class="card-toolbar">
                                        <div class="d-flex justify-content-end w-100 gap-2"
                                            ...
                                            <button type="button" class="btn btn-dark btn-sm"
                                                onclick="window.location.href='{{ route('close.tapping.intelligent-signal.download-interview-audio-to-text-file', encrypt($data->id_tapping_intelligent_signal)) }}'">
                                    ...
                                    <div class="card ">
                                        <div class="card-body">
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ $data->tappingElectronicDevice?->case->satker->nama_satker }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ $data->tappingElectronicDevice?->case->case_name }}</span>
                                                </div>
                                            </div>

                                            <div class="row mb-5">
                                                <div class="col-lg-12">
                                                    <span class="fw-bold fs-6 text-gray-800">PENYADAPAN PERANGKAT
                                                        ELEKTRONIK</span>
                                                    <hr>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-8">
                                                    @if ($data->tappingElectronicDevice?->dokumen_upload)
                                                        <iframe style="width: 100%; height: 500px; overflow: hidden;"
                                                            src="{{ asset('storage/' . $data->tappingElectronicDevice?->dokumen_upload) }}"
                                            ...
                                            <div class="row mb-5">
                                                <div class="col-lg-12">
                                                    <span class="fw-bold fs-6 text-gray-800">PENYADAPAN SINYAL
                                                        PINTAR</span>
                                                    <hr>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ $data->jenis_sinyal }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                                <label class="col-lg-4 fw-semibold text-muted">Deskripsi Hasil</label>
                                            ...
                                            <div class="row mb-5">
                                                <label class="col-lg-4 fw-semibold text-muted">File Video</label>
                                                <div class="col-lg-8">
        ...
        document.getElementById('stopRecordButton').addEventListener('click', () => {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $.ajax({
                        url: '/close/tapping/intelligent_signal/upload-video',
                        type: 'POST',
                        headers: {
                        ...
                        data: {
                            ...
                            id: "{!!$data->id_tapping_intelligent_signal!!}",
