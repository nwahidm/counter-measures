<x-backoffice.layout.app-layout title="Tambah Penyadapan Data Sinyal Pintar">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Tambah Penyadapan Data Sinyal Pintar" subheading=""
                          breadcrumb="close-tapping-intelligent_signal-create"
                          icon="fas fa-users">
                ...
                <div id="kt_app_content" class="app-content flex-column-fluid">
                    <div class="row g-5 g-xl-8">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <form id="form" action="{{ route('close.tapping.intelligent_signal.store') }}"
                                          method="post"
