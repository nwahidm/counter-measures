<x-backoffice.layout.app-layout title="Tambah Lokasi Target Penyurupan">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Tambah Lokasi Target Penyurupan" subheading="" breadcrumb="close-intrusion-target-loc-create"
                          icon="fas fa-users">
                ...
                <div id="kt_app_content" class="app-content flex-column-fluid">
                    <div class="row g-5 g-xl-8">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <form id="form" action="{{ route('close.intrusion.target-loc.store') }}" method="post"
                                        ...
                                        <div class="card ">
                                            <div class="card-body">
                                                ...
                                                <div class="row mb-7">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <textarea
                                                               ...
                                                               value="{{ old('lokasi_target') }}"></textarea>
                                                        @error('lokasi_target')
                                                        <p class="text-danger">{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="row mb-7">
                                                    <div class="form-group col-md-12">
                                                        <label for="deskripsi_lokasi"
                                                               ...
                                                               rows="4">{!! old('deskripsi_lokasi') !!}</textarea>
                                                        </textarea>
                                                ...
                                                <div class="row mb-7">
                                                    <div class="form-group col-md-6">
                                                        <label for="upload_lokasi"
                                                               class="fs-6 fw-semibold mb-2">Upload File Lokasi Target</label>
                                                        <input
                                                            class="form-control form-control-solid @error('upload_lokasi') is-invalid @enderror"
                                                            name="upload_lokasi"
                                                            type="file"
                                                            id="upload_lokasi"
                                                            accept=".pdf"
                                                            value="{{ old('upload_lokasi') }}">
                                                        @error('upload_lokasi')
                                                        <p class="text-danger">{{ $message }}</p>
                                                        @enderror
                                                    </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status = 'sukses') {
                        ...
                        var val_lokasi_target = response.lokasi_target;
