<x-backoffice.layout.app-layout title="Hasil Penyurupan">
    @push('css')
        <style>
            thead {
                font-weight: bold;
    ...
    @endpush
    <x-backoffice.toolbar heading="Hasil Penyurupan" subheading="" breadcrumb="intrusion-result" icon="fas fa-users">
                                ...
                                <div class="card-header border-0 pt-6">
                                    ...
                                    <div class="card-toolbar">
                                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                            <a href="{{ route('close.intrusion.result.create') }}"
    ...
    @push('js')
        <script>
            function deleteData(event) {
                ...
                let url = "{{ route('close.intrusion.result.destroy', ':id') }}";
