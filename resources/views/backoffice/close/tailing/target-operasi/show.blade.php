<x-backoffice.layout.app-layout title="Detail Target Operasi Pembuntutan">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Detail Target Operasi Pembuntutan" subheading="" breadcrumb="open-case-detail"
        icon="fas fa-users">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <div class="d-flex justify-content-end w-100 gap-2"
                                            ...
                                            <button type="button" class="btn btn-dark btn-sm"
                                                onclick="window.location.href='{{ route('close.tailing.target-operasi.download-interview-audio-to-text-file', encrypt($data->id)) }}'">
                                ...
                                <div class="card-body">
                                    <div class="card ">
                                        <div class="card-body">
                                            ...
                                            <label class="fs-3 fw-bold">BIODATA TARGET OPERASI:</label>
                                            <hr>
                                            <div class="row mb-5">
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{!! $data->rencana_target_operasi !!}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{!! $data->target_operasi !!}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{!! $data->skenario_target_operasi !!}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <video controls style="width: 100%; height: 500px;">
                                                        <source src="{{$data->target_operasi_video_upload }}"
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.device_dahua_id) {
                            ...
                            var fileName = "tailing_target_operasi_" + timestamp + "_" + uuid;
                            // Dynamically construct the channelId and playerUrl using JavaScript
        ...
        document.getElementById('stopRecordButton').addEventListener('click', () => {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $.ajax({
                        url: '/close/tailing/target-operasi/upload-video',
                        type: 'POST',
                        headers: {
