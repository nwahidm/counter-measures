...
<table>
    <tr>
        <td colspan="4" class="header">
            LAPORAN PEMBUNTUTAN TARGET OPERASI (AUDIO KE TEKS)
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="4" class="sub-header">Target Operasi</td>
    </tr>
    <tr>
        <td width="10%"></td>
        <td width="30%">Rencana</td>
        <td width="5%">:</td>
        <td>{{ $data->rencana_target_operasi }}</td>
    </tr>
    <tr>
        <td width="10%"></td>
        <td width="30%">Target</td>
        <td width="5%">:</td>
        <td>{{ $data->target_operasi }}</td>
    </tr>
    <tr>
        <td></td>
        <td>Skenario</td>
        <td>:</td>
        <td>{{ $data->skenario_target_operasi }}</td>
    </tr>
