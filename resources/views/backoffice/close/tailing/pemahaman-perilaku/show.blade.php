<x-backoffice.layout.app-layout title="Detail Pemahaman Perilaku Pembuntutan">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Detail Pemahaman Perilaku Pembuntutan" subheading="" breadcrumb="open-case-detail"
        icon="fas fa-users">
                                    ...
                                    <div class="card-toolbar">
                                        <div class="d-flex justify-content-end w-100 gap-2"
                                            ...
                                            <button type="button" class="btn btn-dark btn-sm"
                                                onclick="window.location.href='{{ route('close.tailing.pemahaman-perilaku.download-interview-audio-to-text-file', encrypt($data->id)) }}'">
                                ...
                                <div class="card-body">
                                    <div class="card ">
                                        <div class="card-body">
                                            ...
                                            <div class="row mb-5">
                                                <label class="col-lg-4 fw-semibold text-muted">Jenis Nomor
                                                    Identitas</label>
                                                <div class="col-lg-8">
                                                    <span
                                            ...
                                            <label class="fs-3 fw-bold">PEMAHAMAN PERILAKU:</label>
                                            <hr>

                                            <div class="row mb-5">
                                                <label class="col-lg-4 fw-semibold text-muted">Nama Target
                                                    Pembuntutan</label>
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{!! $data->target_name !!}</span>
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{!! $data->perilaku_tercatat !!}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{!! $data->aktivitas_rutin !!}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                                <label class="col-lg-4 fw-semibold text-muted">Hubungan Sosial</label>
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{!! $data->hubungan_sosial !!}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{!! $data->prediksi_perilaku !!}</span>
                                                </div>
                                            </div>
                                            ...
                                            <hr>
                                            <div class="row mb-5">
                                                <label class="col-lg-4 fw-semibold text-muted mb-3">Lihat Video</label>
                                                <div class="col-lg-8">
                                                    <video controls style="width: 100%; height: 500px;">
                                                        <source src="{{$data->pemahaman_perilaku_video_upload }}"
                                                            do-not-allow="autoplay" frameborder="0"
                                                            style="width: 100%; height: 500px;" type="video/mp4"
                                                            allowfullscreen>
                                                    </video>
                                                </div>
                                            </div>
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.device_dahua_id) {
                            ...
                            var fileName = "tailing_pemahaman_perilaku_" + timestamp + "_" + uuid;
                            // Dynamically construct the channelId and playerUrl using JavaScript
        ...
        document.getElementById('stopRecordButton').addEventListener('click', () => {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $.ajax({
                        url: '/close/tailing/pemahaman-perilaku/upload-video',
                        type: 'POST',
                        headers: {
