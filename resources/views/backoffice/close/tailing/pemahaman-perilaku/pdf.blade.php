...
<table>
    <tr>
        <td colspan="4" class="header">
            LAPORAN PEMBUNTUTAN PEMAHAMAN PERILAKU (AUDIO KE TEKS)
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="4" class="sub-header">BIODATA TARGET (PEMAHAMAN PERILAKU)</td>
    </tr>
    <tr>
        <td width="10%"></td>
        <td width="30%">Nama</td>
    ...
    <tr>
        ...
        <td style="text-align: left;">
            ...
            <div class="image-container">
                @if(!empty($data->target_photo))
                <img src="{{ $data->target_photo }}" alt="Image"
                    style="max-width: 25%;">
                @else
                <p>No image available</p>
                @endif
