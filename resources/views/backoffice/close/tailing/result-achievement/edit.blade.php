<x-backoffice.layout.app-layout title="Ubah Hasil Pencapaian Pembuntutan">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Ubah Hasil Pencapaian Pembuntutan" subheading=""
                    ...
                    <div class="row g-5 g-xl-8">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <form id="form"
                                          action="{{ route('close.tailing.result-achievement.update', $data->id) }}"
                                          method="post"
                                                ...
                                                <div class="row mb-7">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select
                                                            ...
                                                            @if($data->tailing_pemahaman_perilaku_id)
                                                                @foreach ($target_operasi as $row)
                                                                    <option value="{{ $row->id }}" @if($row->id === old('tailing_target_operasi_id', $data->tailing_target_operasi_id)) selected @endif>{!! $row->rencana_target_operasi !!}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
