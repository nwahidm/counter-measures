<x-backoffice.layout.app-layout title="Dashboard">
                    ...
                    <div class="row mb-8">
                            ...
                            <div class="card card-stretch ">
                                <div class="card-body">
                                    <div class="row text-center mb-3">
                                        <h3>Proses Kasus Metode Tertutup</h3>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                        ...
                        <div class="col-6">
                            <div class="card card-stretch ">
                                <div class="card-body">
                                    <div class="row text-center mb-3">
                                        <h3>Statistik Kasus Metode Tertutup</h3>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-6">
                            <div class="card card-stretch ">
                                <div class="card-body">
                                    <div class="row text-center mb-3">
                                        <h3>Top 5 Terbaru - Kasus Metode Tertutup</h3>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="table-responsive">
                                                {{ $lastCloseDataTable->table(['class' => 'table table-striped table-row-bordered gy-5 gs-7 border rounded w-100 text-center', 'id' => 'data-table1'], true) }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-6">
                            <div class="card card-stretch ">
                                <div class="card-body">
                                    <div class="row text-center mb-3">
                                        <h3>Top 5 Terlama - Kasus Metode Tertutup</h3>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="table-responsive">
                                                {{ $earlierCloseDataTable->table(['class' => 'table table-striped table-row-bordered gy-5 gs-7 border rounded w-100 text-center', 'id' => 'data-table2'], true) }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    @push('scripts')
        {{ $lastCloseDataTable->scripts() }}
        {{ $earlierCloseDataTable->scripts() }}
    @endpush
    @push('js')
        <script>
