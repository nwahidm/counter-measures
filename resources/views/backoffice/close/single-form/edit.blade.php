<x-backoffice.layout.app-layout title="Ubah Single Form Close Case">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Ubah Single Form Close Case" subheading="" breadcrumb="close-case-create" icon="fas fa-users">
                ...
                <div id="kt_app_content" class="app-content flex-column-fluid">
                    <div class="row g-5 g-xl-8">
                        <div class="col-md-12" id="formCheck">
                            <div class="card">
                                <div class="card-body">
                                    <form id="form" action="{{ route('close.singleform.single-form.update', $data->id) }}" method="post" enctype="multipart/form-data" autocomplete="off">
                                        @csrf
                                        @method('PUT')
                                        <div class="card ">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="date" class="form-control" name="case_date" id="case_date" value="{{$data->case_date}}"required="required">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <textarea class="form-control " name="case_description" id="case_description" type="text" rows='4'
                                                            placeholder="Lengkapi Data...">{{$data->case_description}}</textarea>
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <select
                                                            ...
                                                            name="satker_id" id="satker_id"
                                                                    data-control="select2" data-hide-search="true" @if(auth()->user()->user_roles != "superadmin") disabled @endif>>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" name="target_religion" id="target_religion" placeholder="" value="{{$data->target_religion}}" >
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <select class="form-select form-select-solid select" name="procedure_type" id="procedure_type">
                                                        <option value="">---Pilih Prosedur---</option>
                                                            <option @if ($data->procedure_type == 'all')
                                                                selected
                                                            @endif value="all">Semua</option>
                                                            <option @if ($data->procedure_type == 'observation')
                                                                selected
                                                            @endif value="observation">Pengamatan</option>
                                                            <option @if ($data->procedure_type == 'delineation')
                                                                selected
                                                            @endif value="delineation">Penggambaran</option>
                                                            <option @if ($data->procedure_type == 'exploration')
                                                                selected
                                                            @endif value="exploration">Penjajakan</option>
                                                            <option @if ($data->procedure_type == 'tailing')
                                                                selected
                                                            @endif value="tailing">Tailing</option>
                                                            <option @if ($data->procedure_type == 'infiltration')
                                                                selected
                                                            @endif value="infiltration">Penyusupan</option>
                                                            <option @if ($data->procedure_type == 'intrusion')
                                                                selected
                                                            @endif value="intrusion">Penyurupan</option>
                                                            <option @if ($data->procedure_type == 'tapping')
                                                                selected
                                                            @endif value="tapping">Penyadapan</option>
                                                        </select>
                                                    </div>
                                                </div>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $data->observation_surat_perintah }}">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <label for="observation_upload_surat_perintah"
                                                                class="fs-6 fw-semibold mb-2 ">Upload File Surat Perintah (Pdf)</label>
                                                            <div class="input-group">
                                                                ...
                                                                @if($data->observation_upload_surat_perintah)
                                                                    <a class="btn btn-dark"
                                                                    href="{{ route('close.singleform.single-form.download-dokumen', encrypt($data->observation_upload_surat_perintah)) }}"
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $data->observation_sumber_informasi }}">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        rows="4">{!! $data->observation_detail_informasi !!}</textarea>
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $data->observation_ancaman_detail }}">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $data->observation_gangguan_detail }}">
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $data->observation_hambatan_detail }}">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $data->observation_tantangan_detail }}">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label for="nama_target" class="fs-6 fw-semibold mb-2">NIK</label>
                                                        <input type="text" class="form-control" name="observation_nik_terkait" id="observation_nik_terkait" placeholder="" value="{{$data->observation_nik_terkait}}">                                                        
                                                        <br>
                                                        <!-- <div class="form-group">
                                                            <button onclick="processCekNik()" id="buttonProcessNik" type="button" class="btn btn-primary btn-lg btn-block">
                                                                Cari
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid @error('observaiton_nama_terkait') is-invalid @enderror"
                                                                name="observaiton_nama_terkait" id="observaiton_nama_terkait" value="{{ $data->observaiton_nama_terkait }}">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            name="observation_jenis_kelamin_terkait" id="observation_jenis_kelamin_terkait" value="{{ $data->observation_jenis_kelamin_terkait }}">
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="row mb-7">
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                name="observation_pekerjaan_terkait" id="observation_pekerjaan_terkait" value="{{ $data->observation_pekerjaan_terkait }}">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                name="observation_pendidikan_terkait" id="observation_pendidikan_terkait" value="{{ $data->observation_pendidikan_terkait }}">
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            name="observation_agama_terkait" id="observation_agama_terkait" value="{{ $data->observation_agama_terkait }}">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select
                                                                ...
                                                                <option value="Tinggi" @if ($data->delineation_informasi_verifikasi_kredibilitas_sumber == 'Tinggi')
                                                                    selected
                                                                @endif>Tinggi</option>
                                                                <option value="Sedang" @if ($data->delineation_informasi_verifikasi_kredibilitas_sumber == 'Sedang')
                                                                    selected
                                                                @endif>Sedang</option>
                                                                <option value="Rendah" @if ($data->delineation_informasi_verifikasi_kredibilitas_sumber == 'Rendah')
                                                                    selected
                                                                @endif>Rendah</option>
                                                            </select>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $data->delineation_informasi_verifikasi_metode_verifikasi }}">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="date"
                                                                ...
                                                                value="{{ $data->delineation_informasi_verifikasi_tanggal_verifikasi }}">
                                                    ...
                                                    <label for="pendahuluan"
                                                        class="fs-6 fw-semibold mb-2 required">Detail Informasi Verifikasi</label>
                                                    <textarea
                                                        class="form-control form-control-solid @error('pendahuluan') is-invalid @enderror"
                                                        name="delineation_informasi_verifikasi_detail_informasi" id="delineation_informasi_verifikasi_detail_informasi">{{ $data->delineation_informasi_verifikasi_detail_informasi }}</textarea>
                                                        ...
                                                        <div class="row mb-7">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    value="{{ $data->delineation_informasi_validasi_metode_validasi }}">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="date"
                                                                    ...
                                                                    value="{{ $data->delineation_informasi_validasi_tanggal_validasi }}">
                                                        ...
                                                        <div class="row mb-7">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <textarea
                                                                    ...
                                                                    name="delineation_informasi_validasi_hasil_validasi" id="delineation_informasi_validasi_hasil_validasi">{{ $data->delineation_informasi_validasi_hasil_validasi }}</textarea>
                                                        ...
                                                        <div class="row mb-7">
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    value="{{ $data->delineation_identitas_terhubung_subjek_utama }}">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    value="{{ $data->delineation_identitas_terhubung_subjek_terkait }}">
                                                        ...
                                                        <div class="row mb-7">
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    value="{{ $data->delineation_identitas_terhubung_jenis_relasi }}">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    value="{{ $data->delineation_identitas_terhubung_kekuatan_relasi }}">
                                        ...
                                        <div class="card mb-3" id="exploration">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea
                                                                    ...
                                                                    name="exploration_rencana_aksi" id="exploration_rencana_aksi">{{ $data->exploration_rencana_aksi }}</textarea>
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label for="nama_target" class="fs-6 fw-semibold mb-2">NIK</label>
                                                        <input type="text" class="form-control" name="exploration_identitas_terhubung_nomor_identitas_target" id="exploration_identitas_terhubung_nomor_identitas_target" placeholder="" value="{{$data->exploration_identitas_terhubung_nomor_identitas_target}}">                                                        
                                                        <br>
                                                        <!-- <div class="form-group">
                                                            <button onclick="processCekNik()" id="buttonProcessNik" type="button" class="btn btn-primary btn-lg btn-block">
                                                                Cari
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid @error('exploration_identitas_terhubung_nama_target') is-invalid @enderror"
                                                                name="exploration_identitas_terhubung_nama_target" id="exploration_identitas_terhubung_nama_target" value="{{ $data->exploration_identitas_terhubung_nama_target }}">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            name="exploration_identitas_terhubung_jenis_kelamin_target" id="exploration_identitas_terhubung_jenis_kelamin_target" value="{{ $data->exploration_identitas_terhubung_jenis_kelamin_target }}">
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="row mb-7">
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                name="exploration_identitas_terhubung_pekerjaan_target" id="exploration_identitas_terhubung_pekerjaan_target" value="{{ $data->exploration_identitas_terhubung_pekerjaan_target }}">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                name="exploration_identitas_terhubung_pendidikan_target" id="exploration_identitas_terhubung_pendidikan_target" value="{{ $data->exploration_identitas_terhubung_pendidikan_target }}">
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            name="exploration_identitas_terhubung_agama_target" id="exploration_identitas_terhubung_agama_target" value="{{ $data->exploration_identitas_terhubung_agama_target }}">
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea
                                                                    ...
                                                                    name="exploration_hasil_yang_dicapai" id="exploration_hasil_yang_dicapai">{{ $data->exploration_hasil_yang_dicapai }}</textarea>
                                        ...
                                        <div class="card mb-3" id="tailing">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label for="tailing_pemahaman_perilaku_nomor_identitas" class="fs-6 fw-semibold mb-2">NIK</label>
                                                        <input type="text" class="form-control" name="tailing_pemahaman_perilaku_nomor_identitas" id="tailing_pemahaman_perilaku_nomor_identitas" placeholder="" value="{{$data->tailing_pemahaman_perilaku_nomor_identitas}}">                                                        
                                                        <br>
                                                        <!-- <div class="form-group">
                                                            <button onclick="processCekNik()" id="buttonProcessNik" type="button" class="btn btn-primary btn-lg btn-block">
                                                                Cari
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid @error('tailing_pemahaman_perilaku_nama') is-invalid @enderror"
                                                                name="tailing_pemahaman_perilaku_nama" id="tailing_pemahaman_perilaku_nama" value="{{ $data->tailing_pemahaman_perilaku_nama }}">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            name="tailing_pemahaman_perilaku_jenis_kelamin" id="tailing_pemahaman_perilaku_jenis_kelamin" value="{{ $data->tailing_pemahaman_perilaku_jenis_kelamin }}">
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="row mb-7">
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                name="tailing_pemahaman_perilaku_pekerjaan" id="tailing_pemahaman_perilaku_pekerjaan" value="{{ $data->tailing_pemahaman_perilaku_pekerjaan }}">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                name="tailing_pemahaman_perilaku_pendidikan" id="tailing_pemahaman_perilaku_pendidikan" value="{{ $data->tailing_pemahaman_perilaku_pendidikan }}">
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            name="tailing_pemahaman_perilaku_agama" id="tailing_pemahaman_perilaku_agama" value="{{ $data->tailing_pemahaman_perilaku_agama }}">
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea
                                                                    ...
                                                                    name="tailing_pemahaman_perilaku_perilaku_tercatat" id="tailing_pemahaman_perilaku_perilaku_tercatat">{{ $data->tailing_pemahaman_perilaku_perilaku_tercatat }}</textarea>
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                >
                                                                @if($data->tailing_pemahaman_perilaku_upload_video)
                                                                    <a class="btn btn-dark"
                                                                    href="{{ route('close.singleform.single-form.download-dokumen', encrypt($data->tailing_pemahaman_perilaku_upload_video)) }}"
                                                                    id="button-addon-file_surat_referensi">
                                                                        <span class="fa fa-file-download"></span> Unduh
                                                                    </a>
                                                                @endif
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <textarea
                                                                    ...
                                                                    name="tailing_rencana_operasi" id="tailing_rencana_operasi">{{ $data->tailing_rencana_operasi }}</textarea>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <textarea
                                                                    ...
                                                                    name="tailing_target_operasi" id="tailing_target_operasi">{{ $data->tailing_target_operasi }}</textarea>
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                @if($data->tailing_target_operasi_upload_video)
                                                                    <a class="btn btn-dark"
                                                                    href="{{ route('close.singleform.single-form.download-dokumen', encrypt($data->tailing_target_operasi_upload_video)) }}"
                                                                    id="button-addon-file_surat_referensi">
                                                                        <span class="fa fa-file-download"></span> Unduh
                                                                    </a>
                                                                @endif
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea
                                                                    ...
                                                                    name="tailing_hasil_yang_dicapai" id="tailing_hasil_yang_dicapai">{{ $data->tailing_hasil_yang_dicapai }}</textarea>
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid @error('infiltration_nama_operasi_rahasia') is-invalid @enderror"
                                                                name="infiltration_nama_operasi_rahasia" id="infiltration_nama_operasi_rahasia" value="{{ $data->infiltration_nama_operasi_rahasia }}">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid @error('infiltration_metode_eksekusi') is-invalid @enderror"
                                                                name="infiltration_metode_eksekusi" id="infiltration_metode_eksekusi" value="{{ $data->infiltration_metode_eksekusi }}">
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                @if($data->infiltration_operasi_rahasia_upload_video)
                                                                    <a class="btn btn-dark"
                                                                    href="{{ route('close.singleform.single-form.download-dokumen', encrypt($data->infiltration_operasi_rahasia_upload_video)) }}"
                                                                    id="button-addon-file_surat_referensi">
                                                                        <span class="fa fa-file-download"></span> Unduh
                                                                    </a>
                                                                @endif
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea
                                                                    ...
                                                                    name="infiltration_dinamika_teramati" id="infiltration_dinamika_teramati">{{ $data->infiltration_dinamika_teramati }}</textarea>
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                @if($data->infiltration_dinamika_teramati_upload_video)
                                                                    <a class="btn btn-dark"
                                                                    href="{{ route('close.singleform.single-form.download-dokumen', encrypt($data->infiltration_dinamika_teramati_upload_video)) }}"
                                                                    id="button-addon-file_surat_referensi">
                                                                        <span class="fa fa-file-download"></span> Unduh
                                                                    </a>
                                                                @endif
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea
                                                                    ...
                                                                    name="infiltration_hasil_yang_dicapai" id="infiltration_hasil_yang_dicapai">{{ $data->infiltration_hasil_yang_dicapai }}</textarea>
                                        ...
                                        <div class="card mb-3" id="intrusion">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label for="intrusion_nomor_identitas" class="fs-6 fw-semibold mb-2">NIK</label>
                                                        <input type="text" class="form-control" name="intrusion_nomor_identitas" id="intrusion_nomor_identitas" placeholder="" value="{{$data->intrusion_nomor_identitas}}">                                                        
                                                        <br>
                                                        <!-- <div class="form-group">
                                                            <button onclick="processCekNik()" id="buttonProcessNik" type="button" class="btn btn-primary btn-lg btn-block">
                                                                Cari
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid @error('intrusion_nama') is-invalid @enderror"
                                                                name="intrusion_nama" id="intrusion_nama" value="{{ $data->intrusion_nama }}">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            name="intrusion_jenis_kelamin" id="intrusion_jenis_kelamin" value="{{ $data->intrusion_jenis_kelamin }}">
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="row mb-7">
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                name="intrusion_pekerjaan" id="intrusion_pekerjaan" value="{{ $data->intrusion_pekerjaan }}">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                name="intrusion_pendidikan" id="intrusion_pendidikan" value="{{ $data->intrusion_pendidikan }}">
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            name="intrusion_agama" id="intrusion_agama" value="{{ $data->intrusion_agama }}">
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <textarea
                                                                    ...
                                                                    name="intrusion_deskripsi_lokasi" id="intrusion_deskripsi_lokasi">{{ $data->intrusion_deskripsi_lokasi }}</textarea>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <textarea
                                                                    ...
                                                                    name="intrusion_tipe_lingkungan" id="intrusion_tipe_lingkungan">{{ $data->intrusion_tipe_lingkungan }}</textarea>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                            ...
                                                            <textarea
                                                                    ...
                                                                    name="intrusion_deskripsi_lingkungan" id="intrusion_deskripsi_lingkungan">{{ $data->intrusion_deskripsi_lingkungan }}</textarea>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <textarea
                                                                    ...
                                                                    name="intrusion_hasil_yang_dicapai" id="intrusion_hasil_yang_dicapai">{{ $data->intrusion_hasil_yang_dicapai }}</textarea>
                                        ...
                                        <div class="card mb-3" id="tapping">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid @error('tapping_sumber_data') is-invalid @enderror" 
                                                                name="tapping_sumber_data" id="tapping_sumber_data" value="{{ $data->tapping_sumber_data }}">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid @error('tapping_metode_penyadapan') is-invalid @enderror" 
                                                                name="tapping_metode_penyadapan" id="tapping_metode_penyadapan" value="{{ $data->tapping_metode_penyadapan }}">
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-12">
                                                            <label for="tapping_data_perangkat_elektronik_upload_video" class="fs-6 fw-semibold mb-2 ">Upload File Video (Penyadapan)</label>
                                                            <div class="input-group">
                                                                ...
                                                                @if($data->tapping_data_perangkat_elektronik_upload_video)
                                                                    <a class="btn btn-dark"
                                                                    href="{{ route('close.singleform.single-form.download-dokumen', encrypt($data->tapping_data_perangkat_elektronik_upload_video)) }}"
                                                                    id="button-addon-file_surat_referensi">
                                                                        <span class="fa fa-file-download"></span> Unduh
                                                                    </a>
                                                                @endif
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid @error('tapping_jenis_sinyal') is-invalid @enderror" 
                                                                name="tapping_jenis_sinyal" id="tapping_jenis_sinyal" value="{{ $data->tapping_jenis_sinyal }}">
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea class="form-control form-control-solid @error('tapping_deskripsi_hasil_sinyal') is-invalid @enderror" 
                                                                    name="tapping_deskripsi_hasil_sinyal" id="tapping_deskripsi_hasil_sinyal">{{ $data->tapping_deskripsi_hasil_sinyal }}</textarea>
                                                    ...
                                                    <div class="row mb-7">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea class="form-control form-control-solid @error('tapping_hasil_yang_dicapai') is-invalid @enderror" 
                                                                    name="tapping_hasil_yang_dicapai" id="tapping_hasil_yang_dicapai">{{ $data->tapping_hasil_yang_dicapai }}</textarea>
    ...
    <script >
        ...
        procedureTypeSelect.value = '{{ $data->close_procedure_type }}';
