<x-backoffice.layout.app-layout title="Surat Perintah Pengamatan">
    @push('css')
        <style>
            thead {
                font-weight: bold;
    ...
    @endpush
    <x-backoffice.toolbar heading="Surat Perintah Pengamatan" subheading="" breadcrumb="observation-directive" icon="fas fa-users">
                                ...
                                <div class="card-header border-0 pt-6">
                                    ...
                                    <div class="card-toolbar">
                                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                            <a href="{{ route('close.observation.directive.create') }}"
    ...
    @push('js')
        <script>
            function deleteData(event) {
                ...
                let url = "{{ route('close.observation.directive.destroy', ':id') }}";
