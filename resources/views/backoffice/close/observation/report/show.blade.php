<x-backoffice.layout.app-layout title="Detail Laporan Pengamatan">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Detail Laporan Pengamatan" subheading="" breadcrumb="open-case-detail"
                          icon="fas fa-users">
