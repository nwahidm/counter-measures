<x-backoffice.layout.app-layout title="Ubah Pihak Terkait">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Ubah Pihak Terkait" subheading="" breadcrumb="edit-observation-connected-identity"
                          icon="fas fa-users">
                ...
                <div id="kt_app_content" class="app-content flex-column-fluid">
                    <div class="row g-5 g-xl-8">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <form id="form" action="{{ route('close.observation.connected-identity.update', $data->id) }}"
                                          method="post"
                                                ...
                                                <div class="row mb-7">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="potensi_aght_id"
                                                               class="fs-6 fw-semibold mb-2">AGHT</label>
                                                            <select
                                                               ...
                                                               @foreach ($aght as $row)
                                                                    <option
                                                                        value="{{ $row['id'] }}"
                                                                        @if($row['id'] === old('potensi_aght_id', $data->potensi_aght_id)) selected @endif>{{ $row['text'] }}</option>
                                                                @endforeach
                                                           </select>
            ...
            if (document.readyState === 'complete') {
                ...
                $('#case_id').change(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            $('#surat_perintah_id').empty();
                            $('#surat_perintah_id').append('<option>---Pilih Surat Perintah---</option>');
                            $.each(response, function(key, value) {
                ...
                $('#surat_perintah_id').change(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $('#information_collection_id').append('<option>---Pilih Informasi---</option>');
                ...
                // ajax get aght
                $('#information_collection_id').change(function() {
