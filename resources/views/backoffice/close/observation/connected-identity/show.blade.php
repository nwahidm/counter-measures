<x-backoffice.layout.app-layout title="Detail Pengamatan Pihak Terkait">
    @push('css')
        <style>
            thead {
                background: #f5f4f8;
    ...
    @endpush
    <x-backoffice.toolbar heading="Detail Pengamatan Pihak Terkait" subheading="" breadcrumb="close-case-observation-threat-detail"
                          icon="fas fa-users">
                                    ...
                                    <div class="card ">
                                        <div class="card-body">
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ $data->threat?->aght_type }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ $data->threat?->perihal }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ $data->threat?->aght_time }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{{ $data->threat?->aght_place }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <span
                                                        class="fw-bold fs-6 text-gray-800" style="text-align: justify">{!! $data->threat?->keterangan !!}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-10">
                                                <label class="col-lg-4 fw-semibold text-muted mb-3">Download File AGHT</label>
                                                <div class="col-lg-8">
                                                    <a class="btn btn-dark btn-sm btn-icon" href="{{ route('close.observation.threat.download-file', encrypt($data->threat?->aght_path)) }}">
                                                        <i class="fas fa-file-download"></i>
                                                    </a>
                                                </div>
                                            </div>
                                            
                                            <label class="fs-3 fw-bold">BIODATA TARGET TERHUBUNG:</label> <hr>
                                            <div class="row mb-5">
