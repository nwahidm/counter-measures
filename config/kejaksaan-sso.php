...
return [
    /**
     * Model untuk cek user di database
     */
    'user_model' => App\Models\User::class,

    /**
     * Field table dari model user_model untuk WHERE condition
     */
    'user_field' => env('SSO_USER_FIELD', 'username'),

    /**
     * Array dari response getUserProfile untuk dimasukan ke WHERE conditon
     */
    'user_profile_field' => env('SSO_USER_PROFILE_FIELD', 'preferred_username'),
